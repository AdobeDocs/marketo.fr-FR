...
# Mes actions de jeton : Modification, suppression, clonage et copie des noms de jeton
...
>[!NOTE]
>
>Les jetons actuellement utilisés dans les ressources ne peuvent pas être supprimés. Si vous essayez de les supprimer, vous recevrez un message d’erreur indiquant les listes d’utilisation du jeton. Supprimez le jeton de ces ressources et essayez de le supprimer à nouveau.
