...
# Tâches de configuration initiales du Marketo Engage{#initial-setup-tasks-for-marketo-engage}

Lors de la première configuration de votre toute nouvelle instance Adobe Marketo Engage, vous devez effectuer quelques tâches. Nous vous recommandons vivement de les exécuter.

Après cette configuration initiale, veuillez consulter notre [Bonnes pratiques pour une nouvelle instance de Marketo Engage](/help/marketo/temp-getting-started-section/temp-best-practice-checklists/where-to-start.md) pour tirer le meilleur parti de votre investissement et vous préparer à la réussite à long terme.

## Tâche 1 : domaines de Liste autorisée {#allowlist-domains}
...
## Tâche 2 : création d’enregistrements DNS pour les pages d’entrée et les courriers électroniques {#step-create-dns-records-for-landing-pages-and-email}
...
## Tâche 3 : Placer sur la liste autorisée les adresses IP de Marketo {#step-allowlist-marketo-ips}
...
## Tâche 4 : configuration de SPF et DKIM {#step-set-up-spf-and-dkim}
...
## Tâche 5 : configuration de DMARC {#set-up-dmarc}
...
## Tâche 6 : configuration des enregistrements MX pour votre domaine {#step-set-up-mx-records-for-your-domain}
