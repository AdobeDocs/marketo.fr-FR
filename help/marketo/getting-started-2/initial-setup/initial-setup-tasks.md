...
Une fois toutes les tâches ci-dessous terminées, passez à la section [Configuration de l’utilisateur](/help/marketo/getting-started-2/initial-setup/user-setup.md) pour effectuer quelques étapes fondamentales pour l’utilisation continue de votre instance.
