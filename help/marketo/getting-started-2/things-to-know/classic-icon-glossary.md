...
Vous trouverez ci-dessous les anciennes icônes de l’interface de Marketo Classic. Le glossaire des icônes actuel peut être : [se trouve ici](/help/marketo/getting-started-2/things-to-know/icon-glossary.md){target="_blank"}.
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>Dossier de destination partagé à partir d’un autre espace de travail <br>(Le cadenas indique que des modifications ne peuvent pas être effectuées)</td> 
  </tr> 
  <tr> 
