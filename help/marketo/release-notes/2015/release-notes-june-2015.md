...
Consultez la personnalisation des valeurs et le contenu recommandé fourni à vos activités marketing. [Ce ](/help/marketo/product-docs/web-personalization/reporting-for-web-personalization/email-reports.md) rapport affiche les pistes directes et assistées attribuées à la personnalisation de RTP et aux campagnes de contenu recommandées. Dans les rapports RTP, Paramètres utilisateur et Envoyer le rapport par courriel, ajoutez le rapport d’attribution par courriel pour recevoir des courriers électroniques mensuels ou trimestriels.
