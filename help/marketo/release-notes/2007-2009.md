...
description: 2007-2009 - Marketo Docs - Documentation sur les produits
title: 2007-2009
...
* **Amélioration de l&#39;envoi du courriel** de test : Vous avez désormais la possibilité d’envoyer la version textuelle du courrier électronique lors de l’envoi d’un courrier électronique de test. Marketo stockera également les 10 dernières listes de destinataires de messagerie électronique de test que vous avez utilisées pour accélérer vos tests de messagerie.
...
* **API** : Vous pouvez maintenant interagir directement avec le système Marketo.
...
* **Pousser les activités de Marketo à Salesforce** : Il vous suffit de cliquer sur admin->Salesforce et de vérifier les activités que vous souhaitez partager avec votre équipe commerciale.
