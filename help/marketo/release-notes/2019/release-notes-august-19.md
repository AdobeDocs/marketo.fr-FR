...
description: Notes de mise à jour - 19 août - Marketo Docs - Documentation du produit
...
Les fonctionnalités suivantes sont incluses dans la version du 19 août. Consultez votre édition Marketo pour connaître la disponibilité des fonctionnalités.
...
* **Cadre** du webinaire extensible : Gagnez du temps avec Marketo qui  un nouveau webinaire prêt à l&#39;emploi (introduit dans la version de  [Winter 19), ](/help/marketo/release-notes/2019/release-notes-winter-19.md) qui transmet de manière transparente les données des fournisseurs de webinaires à Marketo et vice versa. Cvent et Zoom sont désormais disponibles dans cette nouvelle structure.
...
>[!NOTE]
>
>**TLS 1.0 et 1.1 Dépréciation** : Pour nous aligner sur la norme de sécurité de classe mondiale de l’Adobe, nous abandonnerons la prise en charge des normes TLS (Transport Layer Security) 1.0 et 1.1 à compter du 13 décembre 2019. Les systèmes intégrant Marketo qui ne sont pas conformes au protocole 1.2 risquent de perdre l&#39;accès aux services Marketo Engage.
>
>**Pour conserver votre accès Marketo Engage, assurez-vous que tous les systèmes clients sont conformes à la norme TLS 1.2 avant le 13 décembre 2019**. Vous trouverez de plus amples informations [ici](https://nation.marketo.com/docs/DOC-7059-tls-10-11-deprecation-faq).
