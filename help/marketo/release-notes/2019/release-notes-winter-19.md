...
** [Courrier électronique CC pour les courriels marketing](../../product-docs/email-marketing/general/email-cc.md)**
...
** [Segmentation et filtrage basés sur la personnalité ABM](../../product-docs/account-based-marketing/using-personas.md)**
...
Nous prévoyons de déployer notre nouvelle plate-forme avec les fournisseurs au cas par cas. Pour plus d&#39;informations, consultez nos [détails du programme](https://www.marketo.com/why-marketo/partners/technology/) ou contactez votre contact Marketing.
