...
* [Notifications](../../product-docs/core-marketo-concepts/miscellaneous/understanding-notifications/notification-types.md) de l’administrateur marketing pour certains échecs de synchronisation CRM (informations d’identification expirées, limites d’API atteintes, etc.)

* [Possibilité de désactiver les notifications](../../product-docs/crm-sync/salesforce-sync/setup/optional-steps/turn-off-email-notifications-to-lead-owner.md) électroniques aux propriétaires de piste lors de l&#39;affectation de piste
...
** Hiérarchies [](../../product-docs/account-based-marketing/target/named-accounts/abm-hierarchies.md)ABM**
...
** Script [de courriel](../../product-docs/email-marketing/general/using-tokens/create-an-email-script-token.md)dynamique**
...
* ** [Mensuel Cadence ](../../product-docs/email-marketing/email-programs/email-program-actions/scheduling-with-recipient-time-zone/schedule-email-programs-with-recipient-time-zone.md)**d&#39;allaitement :** **Nous avons ajouté la possibilité de programmer des programmes d&#39;alimentation en cadence mensuelle.
...
** Intégration [de correspondance client](../../product-docs/demand-generation/ad-network-integrations/add-google-customer-match-as-a-launchpoint-service.md)Google**
...
** Amélioration [de l’API des Audiences mises en correspondance](../../product-docs/demand-generation/ad-network-integrations/add-linkedin-matched-audiences-as-a-launchpoint-service.md)LinkedIn**
...
** [Créer un segment Web à l&#39;aide de Listes](../../product-docs/web-personalization/using-web-segments/create-a-segment-using-a-static-list.md)statiques**
...
Le contenu recommandé via les algorithmes`<sup>AI </sup>`de contenu optimisé de Marketo génère jusqu’à deux fois plus de clics que le contenu aléatoire.

## Intégration {#integration}

** [Activer/désactiver l’API](http://developers.marketo.com/rest-api/assets/campaigns/)Campaign**
...
À compter du 1er mars 2018, tous les courriels envoyés par [ToutApp.com](http://ToutApp.com) (et en utilisant le bouton &quot;Envoyer un courriel avec tout&quot; dans Salesforce) auront un lien de désabonnement ajouté en bas.
