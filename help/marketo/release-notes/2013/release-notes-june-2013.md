...
Les fonctionnalités suivantes sont incluses dans la version de juin. Veuillez vérifier la disponibilité de vos fonctionnalités dans [Marketo Edition](http://docs.marketo.com/display/docs/assets/pricing.php) .
