...
La version de décembre comprend la fonction très attendue **Transférer à l’ami**, ainsi que plusieurs autres produits ! Notez que les fonctionnalités marquées d’un astérisque (*) sont disponibles uniquement dans les versions Select Edition et RCA (Revenue Cycle Analytics).
...
Utilisez les déclencheurs et filtres correspondants pour identifier les utilisateurs qui ont utilisé le lien **Transférer à l’ami** et ceux qui ont reçu l’e-mail.
...
Accédez à **Admin** > **Chaîne de trésor** pour activer l’**Inspecteur de campagne**.
