...
## Filtre anonyme {#is-anonymous-filter}

[Filtre anonyme](/help/marketo/product-docs/administration/additional-integrations/add-munchkin-tracking-code-to-your-website/next-generation-munchkin-tracking-faq.md)
...
[Tableau de bord de la base de données](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/database-dashboard.md)
...
## Navigateur Microsoft Edge {#microsoft-edge-browser}

[Navigateur Microsoft Edge](/help/marketo/product-docs/administration/setup-administration/supported-browsers.md)
...
## Démarrage Préliminaire Du Programme D’E-Mail {#email-program-head-start}

[Démarrage Préliminaire Du Programme D’E-Mail](/help/marketo/product-docs/email-marketing/email-programs/email-program-actions/head-start-for-email-programs.md)
...
## Améliorations apportées au marketing mobile {#mobile-marketing-enhancements}

[Améliorations apportées au marketing mobile](/help/marketo/product-docs/mobile-marketing/admin/add-a-mobile-app.md)
...
## API du programme {#program-api}

[API du programme](https://developers.marketo.com/documentation/programs/)
...
## Améliorations de Microsoft Dynamics {#microsoft-dynamics-enhancements}

[Améliorations de Microsoft Dynamics](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/microsoft-dynamics-sync-details/sync-status.md)
...
## Améliorations apportées aux objets personnalisés {#custom-objects-enhancements}

[Améliorations apportées aux objets personnalisés](/help/marketo/product-docs/administration/marketo-custom-objects/create-marketo-custom-objects.md)
...
## Publicités de leads Facebook {#facebook-lead-ads}

[Publicités de leads Facebook](/help/marketo/product-docs/demand-generation/facebook/set-up-facebook-lead-ads.md)
...
## Planificateur de campagnes web (Real-Time Personalization) {#web-real-time-personalization-campaign-scheduler}

[Planificateur de campagnes web (Real-Time Personalization)](/help/marketo/product-docs/web-personalization/working-with-web-campaigns/schedule-a-web-campaign.md)
...
[Email Insights](/help/marketo/product-docs/reporting/email-insights/email-insights-overview.md)
...
## Sélecteur de modèle d’e-mail {#email-template-picker}

[Sélecteur de modèle d’e-mail](/help/marketo/product-docs/email-marketing/general/email-editor-2/email-template-picker-overview.md)
...
## Modification des e-mails : repensée {#email-editing-re-imagined}

[Modification des e-mails : repensée](/help/marketo/product-docs/email-marketing/general/email-editor-2/email-editor-v2-0-overview.md)
...
## Messages In-App Mobiles {#mobile-in-app-messages}

[Messages In-App Mobiles](/help/marketo/product-docs/mobile-marketing/in-app-messages/understanding-in-app-messages.md)
...
## Aucun fragment de code de brouillon {#no-draft-snippets}

[Aucun fragment de code de brouillon](/help/marketo/product-docs/administration/users-and-roles/enable-no-draft-for-snippets.md)
...
## Page de destination, modèle de page de destination et API de formulaire {#landing-page-landing-page-template-and-form-apis}

[Page de destination, modèle de page de destination et API de formulaire](https://developers.marketo.com/blog/spring-2016-updates/)
...
## LISTE AUTORISÉE d’adresses IP pour l’accès à l’API {#ip-allowlisting-for-api-access}

[LISTE AUTORISÉE d’adresses IP pour l’accès à l’API](/help/marketo/product-docs/administration/additional-integrations/create-an-allowlist-for-ip-based-api-access.md)
...
## Nouveau Connecteur De Synchronisation Microsoft Dynamics Haute Vitesse {#new-high-speed-microsoft-dynamics-sync-connector}

[Nouveau Connecteur De Synchronisation Microsoft Dynamics Haute Vitesse](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/microsoft-dynamics-sync-details/sync-status.md)
...
## Nom d’instance convivial {#friendly-instance-name}

[Nom d’instance convivial](/help/marketo/product-docs/administration/settings/edit-subscription-settings.md)
...
## Grille d&#39;objets personnalisés {#custom-objects-grid}

[Grille d&#39;objets personnalisés](/help/marketo/product-docs/administration/marketo-custom-objects/understanding-marketo-custom-objects.md)
...
[Marketing basé sur les comptes](https://docs.marketo.com/display/docs/account+based+marketing)
...
[Journal d’audit](/help/marketo/product-docs/administration/audit-trail/audit-trail-overview.md)
...
## Améliorations d’Email 2.0 {#email-enhancements}

[Améliorations d’Email 2.0](/help/marketo/product-docs/email-marketing/general/email-editor-2/email-editor-v2-0-overview.md)
...
[Jetons de programme](/help/marketo/product-docs/demand-generation/landing-pages/personalizing-landing-pages/tokens-overview.md)
...
## Clé d’entreprise {#enterprise-key}

[Clé d’entreprise](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/authorize-the-marketo-outlook-plugin.md)
...
## Campagnes Web Personalization {#web-personalization-campaigns}

[Campagnes Web Personalization](/help/marketo/product-docs/web-personalization/working-with-web-campaigns/create-a-new-dialog-web-campaign.md)

Spécifiez un délai pour que les campagnes web réagissent sur votre site web.

![](assets/dialog-campaign-delay.png)

## Exportation de Content Analytics et de Recommendations {#content-analytics-and-recommendations-export}

[Exportation de Content Analytics et de Recommendations](/help/marketo/product-docs/web-personalization/understanding-web-personalization/understanding-content-analytics.md)

Affichez les données d’analyse de contenu et de recommandations hors ligne.

## Prise en charge des API pour l’éditeur d’e-mail 2.0 {#api-support-for-email-editor}

[Prise en charge des API pour l’éditeur d’e-mail 2.0](https://developers.marketo.com/documentation/asset-api/)
...
## Site des développeurs de Marketo {#marketo-developers-site}

[Site des développeurs de Marketo](https://developers.marketo.com/)

Nouveau et amélioré !

## Paramètres de confidentialité {#privacy-settings}

[Paramètres de confidentialité](/help/marketo/product-docs/administration/settings/understanding-privacy-settings.md)
...
## Conversions hors ligne Facebook {#facebook-offline-conversions}

[Conversions hors ligne Facebook](/help/marketo/product-docs/demand-generation/facebook/understanding-facebook-offline-conversions.md)
...
## Améliorations du journal d’audit {#audit-trail-enhancements}

[Améliorations du journal d’audit](/help/marketo/product-docs/administration/audit-trail/change-details-in-audit-trail.md)
...
## Son pour les notifications push mobiles {#sound-for-mobile-push-notifications}

[Son pour les notifications push mobiles](/help/marketo/product-docs/mobile-marketing/push-notifications/configure-mobile-push-notification.md)
...
## Ventes Insight compatibles avec le chiffrement Salesforce {#sales-insight-compatible-with-salesforce-encryption}

[Ventes Insight compatibles avec le chiffrement Salesforce](/help/marketo/product-docs/marketo-sales-insight/msi-for-salesforce/installation/install-marketo-sales-insight-package-in-salesforce-appexchange.md)
...
## API de comptes nommés {#named-accounts-apis}

[API de comptes nommés](https://developers.marketo.com/rest-api/lead-database/named-accounts/)
...
## Prise en charge de l’API Email Editor v2.0 {#email-editor-v-api-support}

[Prise en charge de l’API Email Editor v2.0](https://developers.marketo.com/rest-api/assets/emails/)

Gérez les variables et les modules pour les e-mails au format v2.0 à l’aide de l’API REST Marketo.

## Modifications apportées à la synchronisation de Marketo Salesforce {#changes-to-marketo-salesforce-sync}

[Modifications apportées à la synchronisation de Marketo Salesforce](https://nation.marketo.com/docs/DOC-3840)
