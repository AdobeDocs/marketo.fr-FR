...
* **Paramètre du décideur au niveau du domaine** : Domaines à deux lettres (c’est-à-dire &quot;  [site web.io](https://website.io)&quot;) sera automatiquement suivi dans Marketo sans configuration supplémentaire requise.
...
* **Service de messagerie électronique** : Bénéficiez d’une meilleure délivrabilité, ainsi que d’une fonctionnalité améliorée de suivi des réponses, de messagerie planifiée et d’e-mail en masse, en vous connectant à Microsoft Outlook (par le biais d’Office365 ou d’On-Prem via l’onglet Connexion par e-mail).
* **Nouveaux paramètres** d’administration : Deux pages d’administration ont été ajoutées pour optimiser votre instance Sales Engage.
   ...
   * _La_ gestion des équipes prend en charge un processus transparent de configuration de compte en permettant aux administrateurs de modifier les abonnements et les équipes.
   * _Les équipes Salesforce Admin_ Settings configurent leur synchronisation SFDC plus rapidement et plus facilement que jamais.
...
>[!NOTE]
>
>Les versions de Marketo Sky se produisent plus fréquemment. Les fonctionnalités et améliorations suivantes devraient être publiées à la fin du 4e trimestre/début du 1er trimestre. Pour plus d’informations et de mises à jour, consultez notre [documentation Sky](https://help.marketo.com/).
...
* **Certification** de type II SOC II : La nouvelle certification en matière de sécurité et de confidentialité s’appuie sur l’accréditation de type I au début de l’année.
...
Nous avons mis à jour notre SDK pour Android vers un framework plus moderne, stable et évolutif qui contient plus de flexibilité et de nouvelles fonctionnalités d’ingénierie. Les développeurs d’applications Android peuvent désormais utiliser directement le service [Firebase Cloud Messaging](https://firebase.google.com/docs/cloud-messaging/) (FCM) de Google avec ce nouveau SDK.
