...
* **[API de ressources de campagne dynamique](https://experienceleague.adobe.com/fr/docs/marketo-developer/marketo/rest/assets/smart-campaigns)** : enrichissez vos analyses en dehors de Marketo avec la récupération d’enregistrements de campagne dynamique par date et identifiant mis à jour.
