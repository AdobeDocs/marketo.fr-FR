...
* **Action de flux Microsoft Dynamics &quot;Changer de propriétaire dans Microsoft&quot;** : Conserver le contrôle de vos données Microsoft Dynamics CRM avec la possibilité de modifier un propriétaire de prospect/contact directement à partir de Marketo Engage. Il s’agit d’une amélioration de notre fonctionnalité d’intégration CRM native.
...
* **Exporter au format PDF** : Partagez des informations précieuses dans l’ensemble de votre entreprise en exportant les tableaux de bord Bizible au format PDF.
