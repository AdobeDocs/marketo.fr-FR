...
L’intégration avec [Google Analytics](/help/marketo/product-docs/web-personalization/reporting-for-web-personalization/web-analytics-integrations/integrate-rtp-with-google-analytics.md) (GA) est désormais activée par défaut. Par conséquent, sous Paramètres du compte, activez le commutateur pour lequel vous souhaitez envoyer les données aux variables et événements personnalisés de GA.
