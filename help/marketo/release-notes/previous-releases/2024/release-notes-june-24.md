---
description: Notes de mise à jour - Juin 2024 - Documents Marketo - Documentation du produit
 ...
 <tbody> 
  <tr> 
   ...
   <th style="width:25%">Documentation</th>
     ...
     <tr> 
   <td><strong>Modèles pour les webinaires interactifs</strong> : les marketeurs peuvent désormais créer des modèles personnalisés pour les mises en page d’espace dans les webinaires interactifs.</td> 
   <td>Expédié</td>
