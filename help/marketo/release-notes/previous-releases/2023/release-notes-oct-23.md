...
* **Obsolescence des événements Marketo et des moments Marketo** : à compter du 2 octobre 2023, Adobe [supprime les événements Marketo et les moments Marketo](https://nation.marketo.com/t5/product-discussions/marketo-events-app-and-marketo-moments-app-end-of-life/m-p/340712/highlight/true#M193869){target="_blank"} de toutes les boutiques d’applications. Utilisateurs existants : vous pouvez continuer à utiliser ces applications jusqu’à ce que vous migriez votre instance Marketo Engage vers Adobe Identity. Ces applications ne prennent pas en charge la connexion avec Adobe ID.
