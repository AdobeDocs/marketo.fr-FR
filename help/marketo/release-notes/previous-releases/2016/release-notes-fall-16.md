...
## [API de comptes nommés](https://experienceleague.adobe.com/fr/docs/marketo-developer/marketo/rest/lead-database/named-accounts) {#named-accounts-apis}
...
## [Prise en charge de l’API de l’éditeur de messagerie électronique v2.0](https://experienceleague.adobe.com/fr/docs/marketo-developer/marketo/email-scripting) {#email-editor-v-api-support}
