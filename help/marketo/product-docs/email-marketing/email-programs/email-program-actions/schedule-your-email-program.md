...
description: Découvrez comment planifier votre programme de messagerie. Définissez la date et l’heure de la diffusion. Vous pouvez également utiliser le fuseau horaire du destinataire.
...
1. Sous la mosaïque **[!UICONTROL Planification]**, définissez la date.
...
1. Vous pouvez également choisir d’utiliser les fonctionnalités [[!UICONTROL Fuseau horaire du destinataire]](/help/marketo/product-docs/email-marketing/email-programs/email-program-actions/scheduling-with-recipient-time-zone/schedule-email-programs-with-recipient-time-zone.md) et/ou [[!UICONTROL Bon départ]](/help/marketo/product-docs/email-marketing/email-programs/email-program-actions/head-start-for-email-programs.md).
