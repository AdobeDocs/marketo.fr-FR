...
description: Découvrez les adresses IP partagées et dédiées, ainsi que leurs avantages et inconvénients. Choisissez l’option qui correspond à vos objectifs de volume d’envoi et de réputation.
...
**Processus de préchauffage d’une adresse IP** - La réputation s’établit au fil du temps. Certains fournisseurs d’accès à Internet (FAI) limitent les adresses IP sans historique de volume, vous devrez donc établir une réputation au cours des premières semaines (Marketo peut vous guider).
