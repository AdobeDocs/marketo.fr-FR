...
description: Découvrez comment créer un modèle d’e-mail dans Email Editor 2.0. Créer des modèles réutilisables avec des modules et des sections modifiables.
