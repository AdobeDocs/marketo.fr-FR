...
* **class :** &quot;mktoImg&quot;.
* **id :** chaîne d’ID. Contient uniquement des lettres, des chiffres, des tirets « - » et des traits de soulignement « _ ». Aucun espace n’est autorisé. Le nom doit être unique.
* **mktoName :** chaîne. Il s’agit du nom d’affichage qui s’affiche dans l’éditeur d’e-mail 2.0. Il est recommandé d’utiliser un nom explicite.  Valeur par défaut (facultatif)
...
* **units:** Unités à ajouter à la valeur numérique (ex : px, pt, em, etc.) lorsqu’elles sont affichées dans l’éditeur d’e-mail, ainsi que dans le code résultant.
