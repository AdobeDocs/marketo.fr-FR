---
description: Document temporaire pour la nouvelle version bêta de Designer Email. Ajouter des ressources et utiliser le concepteur pour les tests bêta (masquer dans la table des matières).
