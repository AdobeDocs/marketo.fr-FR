...
1. Écrivez votre script dans Velocity. Voici quelques ressources utiles :
   ...
   * [Documentation sur les scripts de messagerie des développeurs Marketo](https://experienceleague.adobe.com/fr/docs/marketo-developer/marketo/email-scripting)
