...
description: Découvrez comment envoyer un exemple d’e-mail pour tester le contenu avant le lancement. Utilisez l’éditeur d’e-mail pour envoyer une copie de test à vous-même ou à d’autres personnes.
