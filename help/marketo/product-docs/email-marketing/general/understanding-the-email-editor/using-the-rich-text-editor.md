...
description: Découvrez comment utiliser l’éditeur de texte enrichi pour le contenu des e-mails. Mettre en forme le texte, ajouter des liens et appliquer un style au contenu dans l’éditeur d’e-mail.
...
1. Dans la liste déroulante **[!UICONTROL E-mail] / [!UICONTROL Éditeur de fragment de code]**, sélectionnez `<div>` ou [!UICONTROL Aucun] et cliquez sur **[!UICONTROL Enregistrer]**. `<div>` est utilisé dans cet exemple.
   ...
   Si vous avez `<div class="mktEditable"></div>` dans un modèle d’e-mail, le comportement d’HTML Source suivant s’affiche à l’ouverture de la section et vous saisissez « Le texte se trouve ici » dans l’éditeur :
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td><p>&lt;div class=« mktEditable »&gt;<br>Texte affiché ici<br>&lt;/div&gt;</p></td>
  </tr>
 </tbody>
</table>
...
| ![--](assets/image2015-7-9-10-3a31-3a57.png) | [!UICONTROL Alignement] | Utilisez cette liste déroulante pour mettre en page votre texte et vos images. Centrez-les, choisissez un alignement à gauche ou à droite, ou répartissez-les bord à bord avec une justification complète. |
| ![--](assets/image2015-7-9-10-3a32-3a47.png) | Liste | Sélectionnez des puces ou des nombres dans la liste déroulante. Les puces sont adaptées aux listes et les nombres aux étapes. |
