...
1. Dans la liste déroulante **E-mail / Editeur** d’extrait de code, sélectionnez <div> ou Aucun, puis cliquez sur **Enregistrer**. <div> est utilisée dans cet exemple.
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p>&lt;div class="mktEditable"&gt;<br>&lt;p&gt;Le texte passe ici&lt;/p&gt;<br>&lt;/div&gt;</p></td> 
   <td><p>&lt;div class="mktEditable"&gt;<br>&lt;div&gt;Le texte passe ici&lt;/div&gt;<br>&lt;/div&gt;</p></td> 
   <td><p>&lt;div class="mktEditable"&gt;<br>Texte ici<br>&lt;/div&gt;</p></td> 
  </tr> 
 </tbody> 
</table>
...
>[!TIP]
>
>Vous pouvez également modifier l’élément de bloc racine de l’éditeur de Landing page en suivant les mêmes étapes, mais en cliquant sur la liste déroulante Editeur **de** Landing page de l’étape 4 au lieu de l’Éditeur de courrier électronique/extrait de code.
...
1. Dans la liste déroulante Editeur **de** Landing page, sélectionnez <p> ou Aucun, puis cliquez sur **Enregistrer**. <p> est utilisée dans cet exemple.
