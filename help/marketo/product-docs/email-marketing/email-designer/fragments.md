...
product: marketo
title: Fragments
description: Découvrez comment créer et utiliser des fragments en tant que composants d’e-mail réutilisables. Ajouter des fragments de contenu visuels aux e-mails et aux modèles.
...
1. Cliquez sur l’icône _Thèmes_.
   ...
   >[!INFO]
   >
   >En savoir plus sur les [paramètres de thème](/help/marketo/product-docs/email-marketing/email-designer/brands/brand-themes.md#settings){target="_blank"}.
...
1. Si vous souhaitez mettre à jour le contenu, cliquez sur **[!UICONTROL Créer un brouillon]** en haut à droite.
   ...
   Cliquez sur **[!UICONTROL OK]** dans la boîte de dialogue pour ouvrir le brouillon dans le concepteur visuel. Vous pouvez modifier la `image source`.
