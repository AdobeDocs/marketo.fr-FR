...
1. Définissez la valeur du champ EmailPixelTracking pour chaque personne via l’importation de données (synchronisation des API ou chargement CSV).
...
Dans le Designer d’e-mail, la case à cocher **Désactiver le suivi des ouvertures** se trouve dans l’onglet _Détails_ du volet _Résumé_ à droite de votre e-mail. Dans l’ancien éditeur d’e-mail, la case à cocher **Désactiver le suivi des ouvertures** se trouve dans le menu _Modifier les paramètres_.
...
## Étape 4 : configurer la campagne intelligente {#smart-campaign}

Créez une campagne dynamique afin de déterminer l’e-mail que chaque personne reçoit.
