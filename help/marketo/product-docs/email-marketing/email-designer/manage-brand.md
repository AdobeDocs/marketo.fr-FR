...
Pour accéder au menu **[!UICONTROL Marques]** dans [!DNL Adobe Marketo Engage], les utilisateurs doivent disposer des autorisations **[!UICONTROL Gérer le kit de marque]** ou **[!UICONTROL Activer l’assistant d’IA]**.
