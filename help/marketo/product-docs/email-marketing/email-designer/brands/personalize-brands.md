...
product: Marketo
title: Personnaliser les marques
...
Utilisez l’onglet **[!UICONTROL À propos de la marque]** pour établir l’identité de base de votre marque, en décrivant son objectif, sa personnalité, son slogan et d’autres attributs déterminants.
...
Vous pouvez maintenant [publier votre marque](/help/marketo/product-docs/email-marketing/email-designer/brands/manage-brands.md#create-brand-kit) ou continuer à la personnaliser.
