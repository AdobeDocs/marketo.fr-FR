...
product: marketo
title: Vérificateur de marque
description: Découvrez comment créer, valider et gérer du contenu sur la marque à l’aide du vérificateur de score de marque.
...
# Score de la marque {#brand-score}

La révision de votre score de marque garantit la cohérence du ton, des messages et de l’identité visuelle de vos campagnes par e-mail et sert de contrôle qualité avant la mise en ligne de votre contenu.

>[!AVAILABILITY]
>
>Vous devez accepter le [contrat d’utilisation](https://www.adobe.com/legal/licenses-terms/adobe-dx-gen-ai-user-guidelines.html){target="_blank"}{target="_blank"} avant de pouvoir utiliser l’assistant AI dans Adobe Marketo Engage. Pour en savoir plus, contactez votre représentant Adobe.

## Valider le contenu avec l’alignement sur la marque {#validate-content}

Une fois votre marque [configurée et publiée](/help/marketo/product-docs/email-marketing/email-designer/brands/manage-brands.md#create-brand-kit){target="_blank"}, évaluez son score d’alignement directement dans votre campagne par e-mail pour vous assurer que votre contenu correspond à vos directives de marque.

1. Dans votre e-mail, cliquez sur l’icône **[!UICONTROL Alignement des marques]**.

   Votre contenu évalue automatiquement votre [marque par défaut](/help/marketo/product-docs/email-marketing/email-designer/brands/manage-brands.md#default-brand){target="_blank"}.
...
1. Cliquez sur l’icône ![Plein écran pour obtenir des informations détaillées](assets/icon-fullscreen.svg "Plein écran") pour obtenir une vue détaillée de votre score de qualité.
