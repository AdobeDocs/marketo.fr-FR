...
description: Découvrez comment connecter AEM Cloud Services à Marketo Engage. Utilisez vos ressources AEM lors de la création d’e-mails dans le concepteur.
