...
<tbody>
  ...
  <tr>
    <td>HTML/Changement de version de texte</td>
  ...
  <tr>
    <td>Générer du contenu</td>
    <td>Possibilité de générer l’objet, une partie du contenu ou l’intégralité de l’e-mail via des modèles <a href="/help/marketo/product-docs/email-marketing/email-designer/generate-content.md" target="_blank">IA générative</a>.</td>
  ...
  <tr>
    <td>Convertisseur de modèles d’e-mail</td>
    <td>Possibilité d’<a href="/help/marketo/product-docs/email-marketing/email-designer/import-template.md" target="_blank">importer des modèles Marketo existants</a> dans le nouveau Designer d’e-mail.</td>
  ...
  <tr>
    <td>Éditeur HTML</td>
    <td>Possibilité de modifier le contenu HTML des <a href="/help/marketo/product-docs/email-marketing/email-designer/advanced-html-mode.md">modèles d’email</a>.</td>
    <td>Disponible</td>
    <td>Disponible</td>
  </tr>
  <tr>
