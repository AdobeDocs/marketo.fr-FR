...
description: Découvrez comment afficher le tableau de bord des notifications push. Voir Nombre total d’envois, Nombre total d’appuis et Atténuation du clic pour vos campagnes push.
