---
description: Découvrez comment configurer une notification push mobile. Définissez l’application, le texte du message, appuyez sur les actions, les liens profonds et approuvez l’envoi.
