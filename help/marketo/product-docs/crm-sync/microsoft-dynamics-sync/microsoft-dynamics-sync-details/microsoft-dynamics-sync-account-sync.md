...
Une seule manière : de Dynamics à Marketo.
...
## Une modification d’un champ de compte dans Dynamics entraîne-t-elle un journal d’activité de modification de valeur de données pour chaque contact ?  {#does-a-change-in-an-account-field-in-dynamics-results-in-a-change-data-value-activity-log-for-each-contact}
