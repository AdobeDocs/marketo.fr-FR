...
Si vous avez besoin que les données d’entité personnalisées de [!DNL Dynamics] soient disponibles dans Marketo, voici comment activer la synchronisation de ces données.
