...
description: Découvrez comment utiliser la synchronisation rapide avec Microsoft Dynamics lorsque vous ajoutez un nouveau champ personnalisé. Actualisez les données de champ de Dynamics vers Marketo après l’ajout du champ.
