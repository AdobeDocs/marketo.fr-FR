...
# Versions de plug-in pour Microsoft Dynamics MSI {#plug-in-releases-for-microsoft-dynamics-msi}
...
1. Importez la dernière version de la solution sur la version existante de Dynamics CRM (ex : si votre Dynamics CRM possède la version 1.4 et que la dernière version est 1.5, vous importez *plus* de la version 1.4).
...
## Mises à jour des versions {#version-updates}
