...
description: Découvrez comment créer un filtre de synchronisation Dynamics personnalisé afin que seuls les enregistrements sélectionnés soient synchronisés avec Marketo.
