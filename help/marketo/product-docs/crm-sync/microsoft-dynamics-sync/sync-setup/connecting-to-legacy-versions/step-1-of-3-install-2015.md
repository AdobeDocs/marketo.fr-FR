...
1. Cliquez sur **[!UICONTROL Parcourir]** et sélectionnez la solution que vous avez [téléchargée](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/download-the-marketo-lead-management-solution.md). Cliquez sur **[!UICONTROL Suivant]**.
