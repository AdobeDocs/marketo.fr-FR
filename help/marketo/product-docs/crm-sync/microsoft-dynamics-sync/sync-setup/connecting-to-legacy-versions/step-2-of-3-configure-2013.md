...
description: Découvrez comment configurer l'utilisateur de synchronisation pour Marketo avec Dynamics 2013 On-premise. Configurez l’utilisateur et affectez le rôle Utilisateur de synchronisation Marketo dans Dynamics.
...
1. Sous **[!UICONTROL Paramètres]**, cliquez sur **[!UICONTROL Administration]**.
...
>[!MORELIKETHIS]
>
>[Étape 3 sur 3 : connecter Marketo et [!DNL Dynamics] (2013 On-Premise)](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-3-of-3-connect-2013.md)
