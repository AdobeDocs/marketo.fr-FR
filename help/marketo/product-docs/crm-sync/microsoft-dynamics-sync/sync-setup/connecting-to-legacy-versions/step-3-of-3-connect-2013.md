...
description: Découvrez comment connecter Marketo et Dynamics 2013 On-premise à la dernière étape. Saisissez les informations sur l’utilisateur synchronisé dans Marketo Admin et activez la synchronisation.
...
La synchronisation bidirectionnelle entre Marketo et [!DNL Microsoft Dynamics] est maintenant configurée. Si vous avez acheté [!DNL Marketo Sales Insight], consultez les informations suivantes :
