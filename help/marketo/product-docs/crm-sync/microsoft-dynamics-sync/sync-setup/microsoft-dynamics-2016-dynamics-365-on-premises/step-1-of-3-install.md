...
Avant de pouvoir synchroniser Microsoft Dynamics 2015 On-Premise ou 2016 (Dynamics 365) avec Marketo, vous devez d’abord installer la solution Marketo dans Dynamics.
...
1. Sélectionnez la solution Marketo et cliquez sur **Publier toutes les personnalisations**.
   ...
   >[!MORELIKETHIS]
   >
   >[Installation de Marketo pour Dynamics 2015 On-Prem et 2016 365 On-Prem Étape 2 sur 3](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2015-on-premises/step-2-of-3-set-up.md)
