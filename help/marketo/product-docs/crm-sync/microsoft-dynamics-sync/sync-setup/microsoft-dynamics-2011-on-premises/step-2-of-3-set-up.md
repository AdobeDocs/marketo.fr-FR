...
description: Étape 2 sur 3 - Configuration de l’utilisateur de synchronisation Marketo dans Dynamics (On-Premise 2011) - Documents Marketo - Documentation du produit
...
>[!PREREQUISITES]
[Étape 1 sur 3 : Installation de la solution Marketo (2011 On-Premise)](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2011-on-premises/step-1-of-3-install.md)>
>
...
1. Sélectionnez **Paramètres**. Sélectionnez ensuite **Marketo Config** dans l’arborescence.
   ...
   >[!NOTE]
   Si la configuration Marketo est manquante, essayez d’actualiser la page. Si le problème persiste, [publiez à nouveau la solution Marketo](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2011-on-premises/step-1-of-3-install.md) ou déconnectez-vous et reconnectez-vous.
...
>[!MORELIKETHIS]
[Étape 3 sur 3 : Connexion de Microsoft Dynamics à Marketo (On-Premise 2011)](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2011-on-premises/step-3-of-3-connect.md)
