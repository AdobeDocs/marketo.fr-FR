...
# Étape 1 sur 3 : Installation de la solution Marketo (en ligne) {#step-of-install-the-marketo-solution-online}
...
1. Cliquez sur ![](assets/image2015-3-16-16-3a1-3a13.png)le menu et sélectionnez **CRM**.

   ![](assets/image2015-3-16-16-3a0-3a10.png)

1. Cliquez sur ![](assets/image2015-5-13-10-3a5-3a8.png) le menu. Dans le menu déroulant, sélectionnez **Paramètres **puis sélectionnez **Solutions**.
...
1. Maintenant, revenez sur la page Informations sur la solution, cliquez sur **Suivant**.
