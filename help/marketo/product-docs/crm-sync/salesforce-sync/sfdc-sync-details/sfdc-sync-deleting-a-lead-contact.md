...
description: Synchronisation SFDC - Suppression d’une piste/d’un contact - Documentation Marketo - Documentation du produit
...
* [Supprimer de l’action ](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/delete-person-from-sfdc.md) SFDCflow : Cela supprime un prospect à la DDC mais vous avez le choix de supprimer une personne à Marketo également.
