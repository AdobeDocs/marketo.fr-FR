...
description: Synchronisation SFDC - Campaign Sync - Marketo Docs - Documentation du produit
...
Les Programmes Marketo peuvent être synchronisés avec les campagnes Salesforce. Voici un aperçu de la façon dont cela fonctionne.
...
* Appuyez sur les fonctionnalités de rapports dans Marketo et Salesforce.
...
>[!NOTE]
>
>S&#39;il y a des membres dans le programme Marketo qui n&#39;existent pas dans Salesforce, Marketo les crée comme des leaders dans Salesforce.
...
Oui, utilisez l&#39;action de flux de campagne [Ajouter à la FDC](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/add-to-sfdc-campaign.md). Si cette personne n&#39;existe pas dans Salesforce, Marketo la créera dans Salesforce, puis l&#39;ajoutera à la campagne.
...
## Puis-je modifier l’état des membres de la campagne à l’aide de Marketo ? {#can-i-change-campaign-member-status-using-marketo}
...
>* [Faire de l’utilisateur Marketo Sync un utilisateur marketing](/help/marketo/product-docs/crm-sync/salesforce-sync/setup/optional-steps/enable-disable-campaign-sync/make-marketo-sync-user-a-marketing-user.md)
