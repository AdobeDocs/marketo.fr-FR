...
description: Découvrez comment ajouter des champs Marketo à l’édition professionnelle de Salesforce. Créez un score, un programme d’acquisition et une date d’acquisition sur les objets de lead et de contact.
...
Effectuez les étapes suivantes pour chacun des trois champs personnalisés pour les ajouter. Commencez par **[!UICONTROL Score]**.
...
1. Sélectionnez le type de champ approprié (pour Score - **[!UICONTROL numéro]**; Programme d&#39;acquisition - **[!UICONTROL texte]**; Date d&#39;acquisition - **Date/Heure**).
...
1. Dans le menu Créer sur la gauche, cliquez sur **[!UICONTROL Personnaliser]** et sélectionnez **[!UICONTROL Contacts]**. Cliquez sur **[!UICONTROL Champs]**.
...
1. Saisissez « [!UICONTROL fields] » dans la recherche de navigation sans appuyer sur Entrée. Champs apparaît sous différents objets ; cliquez sur **[!UICONTROL Champs]** sous Leads.
