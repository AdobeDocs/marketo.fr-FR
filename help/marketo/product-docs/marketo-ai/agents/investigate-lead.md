...
Pour afficher la liste complète des scénarios d&#39;enquête, cliquez sur la flèche vers le bas à droite.

CAPTURE D’ÉCRAN

| **Titre** | Description |
|----------|------------|
| **Enquête MQL** | Fournit des détails sur la raison pour laquelle un prospect spécifique n’a pas été qualifié, a cessé de s’engager ou est resté bloqué. |
...
| **Atténuation du score** | Pour savoir pourquoi un score de prospect a chuté de manière inattendue. |

>[!TIP]
>
>Pour afficher rapidement la liste des neuf scénarios, saisissez `/lead investigation` dans la fenêtre d’invite en haut.
