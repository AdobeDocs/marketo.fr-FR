...
* **Les réponses d’Analytics sont basées sur les données disponibles dans votre instance Marketo** : si un programme n’est pas suivi ou si une mesure n’est pas capturée, l’IA Marketo ne sera pas en mesure de créer des rapports dessus.
...
* **L’IA dédiée aux Marketo peut afficher les données, mais ne peut pas apporter de modifications** à vos programmes ou rapports en fonction de ce qu’elle trouve.
