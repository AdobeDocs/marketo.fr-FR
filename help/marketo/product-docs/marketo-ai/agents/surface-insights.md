...
* Les informations de surface sont basées sur les données disponibles dans votre instance Marketo. Si un programme n’est pas suivi ou si une mesure n’est pas capturée, l’IA dédiée au Marketo ne sera pas en mesure de créer des rapports à son sujet.
