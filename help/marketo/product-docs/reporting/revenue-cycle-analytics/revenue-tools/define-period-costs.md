...
description: Découvrez comment définir des coûts de période dans Marketo Engage à l'aide de define-period-cost définir les coûts de période. Utilisez ce guide pour passer à l’étape suivante.
...
1. Saisissez un **[!UICONTROL Coût de la période]** sous forme de nombre entier sans décimales ni virgules (limite maximale : 99999999)
   ...
   >[!NOTE]
   >
   >La devise (ex. : USD, EUR, etc.) est un paramètre global géré par un administrateur Marketo
