...
description: Découvrez l’exemple d’attribution 2 dans Marketo Engage, y compris l’exemple d’attribution 2 attribution-exemple. Utilisez ce guide pour passer à l’étape suivante.
...
* 25 avril | Bill et Joan sont associés à des rôles pour **LES DEUX** Optys
* 29 avril | (Opportunité 1) : close-confirmée
