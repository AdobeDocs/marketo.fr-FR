...
description: Découvrez l’exemple d’attribution 1 dans Marketo Engage, y compris l’exemple d’attribution 1 attribution-exemple. Utilisez ce guide pour passer à l’étape suivante.
...
* 11 avril | Fred est acquis par (Salon professionnel)
