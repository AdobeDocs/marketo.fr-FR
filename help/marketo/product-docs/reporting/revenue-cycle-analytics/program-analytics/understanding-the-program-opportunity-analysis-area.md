...
*&#42;Toutes les opportunités qui ont attribué n’importe quel type de crédit d’attribution à un programme. Les opportunités peuvent être influencées par un ou plusieurs prospects et par un ou plusieurs programmes.*
