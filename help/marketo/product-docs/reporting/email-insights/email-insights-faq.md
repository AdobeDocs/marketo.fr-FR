...
description: Trouvez des réponses aux questions fréquentes sur les Insights sur les e-mails, y compris les calculs de mesures, les dimensions personnalisées et le filtrage des appareils. Comprenez en quoi les informations sur les e-mails diffèrent des autres outils de création de rapports.
