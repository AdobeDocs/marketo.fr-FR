...
Évaluer la [contribution de Marketing au chiffre d&#39;affaires](/help/marketo/product-docs/reporting/performance-insights/performance-insights-contribution-overview.md) en fonction de l&#39;acquisition, de l&#39;influence, de la conversion des clients, voire de la croissance de base installée.
...
Découvrir [les tendances à long terme](/help/marketo/product-docs/reporting/performance-insights/performance-insights-trend-overview.md) pour repérer les stratégies gagnantes cohérentes.

![](assets/4.png)

## Paramètres {#settings}

Dans les tableaux de bord Recettes et Pipeline, cliquez sur l&#39;icône [Paramètres](/help/marketo/product-docs/reporting/performance-insights/performance-insights-settings.md) pour définir d&#39;autres paramètres.

![](assets/5.png)

## Exporter des données {#export-data}

Vous pouvez exporter les données et les graphiques dans PowerPoint ou Excel. Vous pouvez également les enregistrer sous la forme [Graphique rapide](/help/marketo/product-docs/reporting/performance-insights/performance-insights-quick-charts.md).
