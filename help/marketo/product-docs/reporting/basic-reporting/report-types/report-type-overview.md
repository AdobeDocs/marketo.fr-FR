...
description: Découvrez les types de rapports disponibles, notamment les rapports Performances des personnes, Performances des e-mails, Performances des e-mails de Campaign et Activité web . Choisissez le type de rapport adapté à vos besoins en matière d’analyse.
...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>Statistiques sur les liens individuels dans vos emails.</td>
  </tr>
  <tr>
   ...
   <td>Vérifier les interactions avec vos e-mails : envoyés ou rebonds, ouverts, sur lesquels l’utilisateur ou l’utilisatrice a cliqué, désabonnés, etc.</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>Générez des rapports sur l’activité web sur vos pages de destination et votre site web public, regroupés par société.</td>
  </tr>
  <tr>
   <td><strong><a href="web-page-activity-report.md">Activité de page Internet</a></strong></td>
   <td>Générez des rapports sur l’activité web sur vos pages de destination et votre site web public.</td>
  </tr>
  <tr>
