...
description: Découvrez comment parcourir la page d’accueil d’Analytics pour accéder à différents types de rapports et revenir à la vue d’accueil. Sélectionnez des types de rapports et gérez votre espace de travail de création de rapports.
