...
description: Découvrez comment exporter des rapports vers des fichiers Excel pour les analyser dans d’autres logiciels. Cliquez sur le bouton Exporter de l’onglet Rapport pour télécharger vos données.
