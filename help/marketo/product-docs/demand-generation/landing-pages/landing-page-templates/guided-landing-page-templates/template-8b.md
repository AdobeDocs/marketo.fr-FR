...
description: Découvrez le modèle de page de destination guidée par le modèle 8B. Téléchargez-le et utilisez-le pour vos pages de destination Marketo.
title: Modèle 8B
...
* Une section principale
   ...
   * comprend un en-tête de héros, une image de héros et un texte de héros
