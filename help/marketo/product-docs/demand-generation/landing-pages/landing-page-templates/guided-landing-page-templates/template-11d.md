...
description: Découvrez le modèle de page de destination guidée Template 11D. Téléchargez-le et utilisez-le pour vos pages de destination Marketo.
title: Modèle 11D
...
Cliquez avec le bouton droit sur [Télécharger le modèle 11D](https://51837-micrositemarketo.adobeio-static.net/lp-templates/template-11d.html) et sélectionnez **Enregistrer le lien sous...**
...
* Une section principale
  ...
  * inclut un titre de héros, un texte de héros et un questionnaire

* Sept sections de corps (facultatif)
...
[Modèle 11D.html](https://51837-micrositemarketo.adobeio-static.net/lp-templates/template-11d.html)
