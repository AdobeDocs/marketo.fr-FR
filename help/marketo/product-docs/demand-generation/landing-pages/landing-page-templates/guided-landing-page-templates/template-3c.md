...
description: Découvrez le modèle de page de destination guidée par le modèle 3C. Téléchargez-le et utilisez-le pour vos pages de destination Marketo.
title: Modèle 3C
...
Cliquez avec le bouton droit [télécharger le modèle 3C](https://51837-micrositemarketo.adobeio-static.net/lp-templates/template-3c.html) et sélectionnez **Enregistrer le lien sous...**
...
* Une section principale
  ...
  * inclut le texte principal et le sondage.
...
[Modèle 3C.html](https://51837-micrositemarketo.adobeio-static.net/lp-templates/template-3c.html)
