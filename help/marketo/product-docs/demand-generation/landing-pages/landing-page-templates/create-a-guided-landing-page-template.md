...
description: Découvrez comment créer un modèle de page de destination guidée dans Marketo. Utilisez la syntaxe pour définir les régions modifiables et les variables pour l’éditeur guidé.
...
>[!TIP]
>
>L’utilisation de conventions de nommage claires facilite l’utilisation du modèle par votre équipe marketing.
...
Exemple : `<div class="mktoText" id="exampleText" mktoName="Main Body Text"> Optionally add default text for the editable text area.</div>`
...
Exemple : `<div class="mktoImg" id="exampleImg" mktoName="Example Image"></div>`
...
Exemple : `<img class="mktoImg" id="exampleImg" mktoName="Example Image">`

>[!NOTE]
>
>Lors de l’utilisation de la version `<img>`, l’HTML rendue contiendra un wrapper div généré autour de la balise `<img>`. Elle sera définie sur la classe « mktoImg mktoGen » et sera affichée:inline-block.
...
Exemple : `<div class="mktoForm" id="exampleForm" mktoName="Example Form"></div>`
...
Exemple : `<div class="mktoSnippet" id="exampleSnippet" mktoName="Example Snippet"></div>`
...
Exemple : `<div class="mktoShareButton" id="exampleShareButton" mktoName="Example Share Button"></div>`
...
Exemple : `<div class="mktoVideo" id="exampleVideo" mktoName="Example Video"></div>`
...
Exemple de base : `<meta class="mktoString" id="var1" mktoName="My Variable">`

Exemple avec tous les attributs : `<meta class="mktoString" id="var1" mktoName="My Variable" default="This is my default value" allowHtml="true">`
...
Exemple de base : `<meta class="mktoColor" id="color1" mktoName="My Color Variable">`

Exemple avec tous les attributs : `<meta class="mktoColor" id="color" mktoName="My Color Variable" default="#336699">`
...
Exemple de base : `<meta class="mktoBoolean" id="boolean1" mktoName="My Boolean Variable">`

Exemple avec tous les attributs : `<meta class="mktoBoolean" id="boolean1" mktoName="My Boolean Variable" default="false" true_value="block" false_value="none" true_value_name="Show" false_value_name="Hide">`

L’exemple ci-dessous illustre un cas d’utilisation courant où une variable booléenne contrôle la visibilité d’un élément css en définissant la valeur de la propriété d’affichage css sur « block » ou « none » pour afficher/masquer un élément par identifiant avec CSS. L’éditeur de page de destination utilise le nom d’affichage Afficher/Masquer au lieu de Désactiver/Activer.
