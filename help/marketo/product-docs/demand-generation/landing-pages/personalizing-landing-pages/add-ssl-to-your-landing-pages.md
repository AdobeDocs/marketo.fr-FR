...
description: Découvrez comment ajouter SSL à vos pages de destination Marketo. Activez HTTPS pour sécuriser les URL des pages de destination.
...
## Modification des SSL dans les alias de domaines existants {#edit-ssl-existing-domain}
...
<tr>
  ...
  <tr>
    ...
    <td>Une erreur inattendue s’est produite. Veuillez rassembler les journaux et les détails de l'erreur, puis signaler le problème à l'assistance de <a href="https://nation.marketo.com/t5/support/ct-p/Support" target="_blank"></a>.</td>
  </tr>
</tbody></table>
