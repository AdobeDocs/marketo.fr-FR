...
1. Basculer entre les deux pour choisir la variable **Thème de formulaire** de votre goût.
...
1. Cliquez sur **Suivant** pour configurer d’autres options de formulaire, ou cliquez sur **Terminer** si vous souhaitez uniquement modifier le thème du formulaire.

   ![](assets/image2014-9-15-17-3a8-3a22.png)

C&#39;était facile?! Vous pouvez laisser votre livre de HTML/CSS ramasser de la poussière maintenant.
