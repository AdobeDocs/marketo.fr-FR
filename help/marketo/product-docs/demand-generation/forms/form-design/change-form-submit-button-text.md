...
description: Découvrez comment modifier le texte du bouton Envoyer du formulaire dans Marketo. Personnalisez le libellé sur le bouton sur lequel les visiteurs cliquent pour envoyer la ressource.
