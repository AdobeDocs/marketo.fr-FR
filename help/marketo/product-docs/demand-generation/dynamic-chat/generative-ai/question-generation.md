---
description: Découvrez comment générer des questions pour Dynamic Chat à l’aide des URL sources et des rubriques. Créez des réponses assistées par l’IA et suivez le statut des tâches dans les réponses assistées.
