---
description: Découvrez comment utiliser les attributs de personne Demandbase dans Dynamic Chat pour le ciblage et le routage des boîtes de dialogue. Obtenez votre clé API et activez l’intégration.
title: Demandbase
