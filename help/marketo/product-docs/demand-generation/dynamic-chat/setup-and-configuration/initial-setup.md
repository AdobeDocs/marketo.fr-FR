...
1. Une fois connecté au Admin Console, la prochaine chose à faire est d’ajouter des utilisateurs. Nous avons ce processus [documenté ici](/help/marketo/product-docs/demand-generation/dynamic-chat/setup-and-configuration/add-or-remove-chat-users.md#add-a-chat-user){target="_blank"}.

Ensuite, il est temps de [Connexion du Dynamic Chat à Marketo](/help/marketo/product-docs/demand-generation/dynamic-chat/integrations/adobe-marketo-engage.md){target="_blank"}.
