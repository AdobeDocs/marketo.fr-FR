...
description: Découvrez comment créer un programme d’événement dans Marketo. Configurez votre programme, choisissez un canal et configurez les paramètres d’événement.
