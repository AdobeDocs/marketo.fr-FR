...
description: Découvrez comment créer un événement avec Adobe Connect dans Marketo. Configurez l’intégration et synchronisez les données d’inscription et de présence.
...
Tout d’abord, vérifiez que vous avez créé votre réunion ou séminaire dans Adobe Connect. Si vous avez besoin d’aide, consultez le [Guide de l’utilisateur &#x200B;](https://help.adobe.com/fr_FR/connect/9.0/using/index.html).
