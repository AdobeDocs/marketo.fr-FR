...
description: Découvrez comment tester votre intégration d’événement ON24 avec Marketo. Vérifiez que la synchronisation, le flux d’enregistrement et les mises à jour de statut fonctionnent correctement.
