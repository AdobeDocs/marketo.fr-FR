...
Après avoir créé un événement Marketo et associé le GoToWebinar à celui-ci, les systèmes pourront partager les informations d&#39;inscription et de présence. Pour obtenir de l’aide sur la création d’un [webinaire GoToWebinar, consultez le Guide](http://docs.marketo.com/display/docs/assets/gotowebinar-user-guide.pdf)de l’utilisateur de GoToWebinar.
...
`Enter the following information for your webinar and it will be pulled into Marketo via the`adaptateur. Si vous apportez des modifications à ces informations, vous devez cliquer sur le lien &quot;**Actualiser à partir du fournisseur** de webinaire&quot; sous Actions ****&#x200B;Événement, afin que Marketo puisse les voir.

**Date** du début - entrez votre date de début. Ceci sera visible dans Marketing Cloud.

**Heure** de début - entrez l&#39;heure de début. Ceci sera visible dans Marketing Cloud.
...
>[!TIP]
>
>D&#39;autres champs que vous allez configurer dans GoToWebinar n&#39;affecteront PAS l&#39;intégration. Veuillez consulter le Guide [de l&#39;utilisateur](http://docs.marketo.com/display/docs/assets/gotowebinar-user-guide.pdf) GoToWebinar pour plus d&#39;informations sur ces champs, car ils ne seront pas traités dans cet article. Si vous avez besoin d&#39;une aide supplémentaire de GoToWebinar, veuillez visiter leur site [d&#39;](http://support.logmeininc.com/gotowebinar)aide.
...
1. Choisissez **Atteindre le webinaire** dans la Liste de **partenaire** **Événement** .
