...
* **Informations d’identification de connexion ON24** - Vous devrez saisir ces informations dans Marketo pour activer l’intégration : nom d’utilisateur, mot de passe, identifiant client et clé client. Contactez votre gestionnaire de compte ON24 ou l&#39;assistance ON24 si vous avez besoin d&#39;aide pour vos informations d&#39;identification.
...
1. [Configurer des paramètres d’événement et synchroniser Marketo avec votre webinaire](/help/marketo/product-docs/demand-generation/events/create-an-event/create-an-event-with-the-marketo-on24-adapter/configure-event-settings-and-sync-marketo-with-your-webinar.md){target="_blank"}
1. [Créer des campagnes enfant et des ressources locales](/help/marketo/product-docs/demand-generation/events/create-an-event/create-an-event-with-the-marketo-on24-adapter/create-child-campaigns-and-local-assets.md){target="_blank"}
