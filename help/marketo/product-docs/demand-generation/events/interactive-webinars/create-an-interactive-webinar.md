...
Votre webinaire interactif est créé. Vous avez désormais la possibilité d’ajouter une équipe de webinaires.

## Équipe de webinaires {#webinar-team}
...
### Ajout d’une équipe de webinaires {#adding-a-webinar-team}

Pour ajouter un co-hôte ou un présentateur, cliquez sur **Ajout de co-hôtes** ou **Ajouter des présentateurs** dans l’écran Aperçu .
