...
1. Vous pouvez choisir une salle de webinaire existante ou en créer une nouvelle. Dans cet exemple, nous en créons un nouveau. Cliquez donc sur la liste déroulante **Sélectionner la salle** et choisissez **Nouvelle salle de webinaire interactive**.
   ...
   >
   >* Si vous choisissez une salle de webinaire existante et devez la renommer, cliquez simplement sur le bouton **Renommer la salle de webinaire** situé à droite.
   >
...
1. Vous pouvez sélectionner différentes mises en page à prévisualiser. Pour continuer, cliquez sur **Utiliser le modèle**.

   ![](assets/designing-interactive-webinars-5.png)

1. Vous pouvez affiner immédiatement votre webinaire ou plus tard. Faisons-le maintenant. Cliquez sur **Affiner votre webinaire maintenant**.
