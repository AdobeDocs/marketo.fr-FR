...
Le tableau de bord effectue le suivi de diverses mesures, notamment des réponses aux sondages, de l’activité de chat et des interactions vidéo, offrant des informations précieuses sur les préférences et les comportements des participants. Il offre un aperçu complet des niveaux d’activité et d’engagement des participants, ce qui permet aux hôtes de surveiller la participation, la participation et les interactions en temps réel.
...
Cette interface fournit un aperçu des performances d’un événement de la session en direct. La présentation comprend des mesures clés, l’engagement au fil du temps et les interactions des participants. Il aide les organisateurs à évaluer le succès de l’événement et à identifier les domaines à améliorer.

Dans le panneau de gauche, sélectionnez Engagement pour afficher les performances de la session en direct. Sélectionnez Synthèse de l’engagement (PDF) pour télécharger le résumé des performances de la session en direct. La présentation est classée en différentes sections.

CAPTURE D’ÉCRAN

**Mesures clés**

Affichez le nombre d’inscriptions, de participants et d’engagements dans la session en direct à partir des mesures clés.
...
<table><tbody>
  ...
  <tr>
    ...
    <td>Affiche la durée moyenne de la montre en minutes de session en direct.</td>
  </tr>
</tbody>
</table>
...
Découvrez l’engagement moyen au fil du temps au cours de la session en direct à partir des graphiques d’engagement. Les hôtes peuvent surveiller la fluctuation des niveaux d’engagement, ce qui leur permet d’identifier les moments critiques d’une interaction élevée ou faible. Vérifiez le score d’engagement moyen obtenu par les participants engagés dans différentes dispositions.
...
* Sélectionnez Afficher l’instant dans l’enregistrement pour afficher l’instant dans l’enregistrement où l’engagement était élevé ou faible.
...
Sélectionnez Atteindre les interactions pour afficher les réponses des sondages, les mesures de Q&amp;R et les réactions des participants au cours de la session. Découvrez comment les participants sont engagés dans plusieurs capsules à partir d’ Interactions et téléchargez des rapports d’interaction à partir de la section ci-dessous.

### Interactions {#interactions}

Affichez la manière dont les participants interagissent et participent à la session dans Interactions. Suivez les réponses aux sondages, aux mesures Q&amp;R, aux réactions des participants, ainsi que les liens et fichiers déposés depuis les capsules respectives. Les hôtes peuvent également télécharger des rapports d’interaction de ces capsules pour une meilleure analyse. En analysant ces interactions, identifiez les tendances et ajustez leurs stratégies afin d’encourager un environnement plus interactif et plus engageant.

Dans le panneau de gauche, sélectionnez Interactions pour afficher le mode d’interaction des participants entre les capsules.

CAPTURE D’ÉCRAN

Sélectionnez l’onglet Sondages dans la barre de menus pour afficher les questions et réponses ajoutées au sondage. Cet onglet affiche les informations suivantes :

* Sélectionnez Rapport Sondage (CSV) pour télécharger le rapport pour les interactions dans la capsule de sondage.
...
* Sélectionnez Afficher toutes les réponses `<number>` pour les afficher dans une fenêtre de boîte de dialogue.

Sélectionnez l’onglet Autres interactions dans la barre de menus pour afficher l’engagement dans d’autres capsules et télécharger leurs rapports.

CAPTURE D’ÉCRAN

Sélectionnez Télécharger les rapports d’interaction dans la liste déroulante supérieure droite pour télécharger les rapports de différentes capsules. Téléchargez le rapport Q&amp;R, le rapport Liens et fichiers et le rapport Réactions à partir de là pour un meilleur suivi.
...
Dans le panneau de gauche, sélectionnez l’activité À la demande pour afficher la synthèse des enregistrements. Vous pouvez également télécharger un rapport pour l’activité à la demande.

CAPTURE D’ÉCRAN

Dans l’activité à la demande, consultez les mesures suivantes :

* Sélectionnez Rapport à la demande (CSV) pour télécharger les mesures à la demande.
...
* Nombre de visionneuses qui se sont enregistrées pour une session à la demande.
* Durée moyenne de la montre de l’enregistrement en minutes.

### Activité de participant {#participant-activity}

Dans le panneau de gauche, sélectionnez Activité de participant pour afficher des informations consolidées sur le niveau d’engagement de chaque participant. Découvrez comment cet engagement est classé en niveaux par niveau d’engagement des participants. Sélectionnez Rapport d’activité de l’utilisateur (CSV) pour télécharger le rapport afin d’en améliorer le suivi.
...
1. Dans le panneau de gauche, sélectionnez Télécharger des rapports.
1. Sélectionnez Télécharger tout (.zip) pour télécharger simultanément des rapports pour toutes les activités et capsules.

CAPTURE D’ÉCRAN

Pour les télécharger individuellement, cliquez sur l’icône en regard de chaque rapport.

## Niveau d’engagement des participants {#participant-engagement-level}

Les entreprises utilisent Adobe Connect pour proposer des webinaires personnalisés, de marque et axés sur l’engagement. Les outils interactifs tels que les sondages, le chat, les questions et réponses et les réactions permettent d&#39;impliquer les participants et de collecter plus que de simples données d&#39;inscription et de présence. Une fois que les participants utilisent ces fonctionnalités interactives, les données d’engagement sont utilisées pour classer les participants en trois niveaux d’engagement : élevé, moyen et faible. Les marketeurs peuvent utiliser le niveau d’engagement pour mettre à jour les segments d’audience, mettre à jour les scores de piste et alerter les ventes.

Comprendre le critère de classification du niveau d’engagement pour chaque participant :

<table><thead>
  <tr>
    <th>Niveau d’engagement</th>
    <th>Critère de classification</th>
  </tr></thead>
<tbody>
  <tr>
    <td>Haut</td>
