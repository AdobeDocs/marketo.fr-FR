...
Lorsque vous [publication d’un tirage](/help/marketo/product-docs/demand-generation/social/sweepstakes/publish-a-sweepstakes.md), vous devez sélectionner les gagnants pour chaque dessin. Lorsque vous le faites, votre [email d’exécution](/help/marketo/product-docs/demand-generation/social/social-functions/use-emails-in-social-promotions.md) leur est automatiquement envoyé.
...
1. Cliquez sur **Finaliser** pour envoyer la variable [email d’exécution](/help/marketo/product-docs/demand-generation/social/referral-offers/send-referral-offer-fulfillment-email.md) aux gagnants répertoriés.
