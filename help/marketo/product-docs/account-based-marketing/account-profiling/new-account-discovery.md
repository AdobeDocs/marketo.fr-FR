...
>[!PREREQUISITES]
>
>[Configurer le profilage de compte](/help/marketo/product-docs/account-based-marketing/account-profiling/setting-up-account-profiling.md)
...
1. Cliquez sur **OK**.
   ...
   >[!TIP]
   >
   >Une fois vos comptes enregistrés, vous pouvez utiliser une audience [correspondante sur LinkedIn](/help/marketo/product-docs/account-based-marketing/target/create-a-matched-audience-on-linkedin.md) pour les cible.
