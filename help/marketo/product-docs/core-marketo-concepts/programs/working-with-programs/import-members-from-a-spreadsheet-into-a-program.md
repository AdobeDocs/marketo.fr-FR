...
description: Importation de membres d’une feuille de calcul dans un programme - Documents Marketo - Documentation du produit
...
1. Créez un fichier CSV standard dans Excel, comme dans l’exemple ci-dessous.
   ...
   >[!CAUTION]
   >
   >Lors de l&#39;import d&#39;une date dans un champ de date, utilisez le format suivant : 9/29/24 (mois/jour/année).
...
1. Patientez jusqu’à ce que Marketo termine l’importation, puis fermez la boîte de dialogue de confirmation.
