...
description: Découvrez comment synchroniser une campagne Salesforce avec un programme Marketo. Gardez le statut du membre synchronisé entre SFDC et Marketo.
title: Synchroniser une campagne Salesforce avec un programme
...
# Synchroniser une campagne Salesforce avec un programme {#sync-an-sfdc-campaign-with-a-program}
...
1. Vous pouvez maintenant vérifier les détails de synchronisation de la campagne dans la page de résumé du programme.
   ...
   Les modifications de statut du programme dans Marketo sont désormais synchronisées avec la campagne SFDC et vice versa.
