...
description: Découvrez comment utiliser les coûts de période dans un programme. Ajoutez et affectez des coûts aux périodes de programme pour la création de rapports sur le retour sur investissement.
