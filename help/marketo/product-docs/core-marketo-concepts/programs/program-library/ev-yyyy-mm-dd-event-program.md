...
>[!NOTE]
>
>Avant l’événement, téléchargez les informations d’enregistrement dans votre iPad. Vérifiez ensuite les visiteurs et resynchronisez les informations de présence dans Marketo Engage. Si vous n&#39;avez pas de tablette, vous pouvez [importer des participants](/help/marketo/product-docs/core-marketo-concepts/programs/working-with-programs/import-members-from-a-spreadsheet-into-a-program.md){target="_blank"} par la suite, sous l’onglet &quot;Membres&quot; du programme, avant d’envoyer vos emails de relance.
