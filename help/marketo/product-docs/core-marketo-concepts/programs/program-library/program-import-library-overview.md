...
La bibliothèque comprend des programmes tels que : email, engagement, événement, notation, délivrabilité et opérationnel. Tous les programmes ont été développés par l’équipe produit Adobe et testés par notre équipe [services professionnels mondiaux](https://business.adobe.com/customers/consulting-services/main.html){target="_blank"} s&#39;efforçant d&#39;optimiser la qualité et l&#39;efficacité.

## Exemples de programmes disponibles {#available-program-examples}

* [AEM-AAAA-MM-JJ-Envoi de courrier électronique unique](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/em-yyyy-mm-dd-single-email-send.md){target="_blank"}
...
* [EV-YYYY-MM-DD-Event Program](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/ev-yyyy-mm-dd-event-program.md){target="_blank"}
...
* [CT-AAAA-MM-Contenu sur la page d’entrée Marketo](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/ct-yyyy-mm-content-on-marketo-landing-page.md){target="_blank"}
...
* [Page d’entrée OA-AAAA-MM-Marketo de publicité en ligne](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/oa-yyyy-mm-online-advertising-marketo-landing-page.md){target="_blank"}

* [Gestion des données OP](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/op-data-management.md){target="_blank"}

* [Gestion des leads OP](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/op-lead-management.md){target="_blank"}
...
* [Gestion de la délivrabilité des OP](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/op-deliverability-management.md){target="_blank"}
