...
1. Sélectionnez un programme qui contient votre campagne dynamique.
...
1. Sélectionnez le menu déroulant du type d’entrée et choisissez la campagne dynamique que vous souhaitez réexécuter.
   ...
   >[!TIP]
   >
   >Vous pouvez également effectuer cette opération à partir de la [mise au point du programme](/help/marketo/product-docs/core-marketo-concepts/marketing-calendar/understanding-the-calendar/understand-enable-program-focus.md).

Boum ! De la même manière, vous avez planifié une autre opération pour cette campagne intelligente. Si cette campagne intelligente contenait des étapes d’envoi d’emails, vous verrez également ces étapes !
