...
L’application Marketo Events pour la tablette [!DNL iPad] ou [!DNL Android] facilite l’enregistrement des personnes immédiatement lorsqu’elles arrivent à votre événement.
...
* [Créez un nouveau rôle Marketo](/help/marketo/product-docs/core-marketo-concepts/mobile-apps/event-check-in/grant-users-access-to-the-check-in-app.md){target="_blank"} pour les utilisateurs [!DNL iPad] ou [!DNL Android] pour l’événement
* [Invitation de nouveaux utilisateurs de tablette à l’événement](/help/marketo/product-docs/core-marketo-concepts/mobile-apps/event-check-in/grant-users-access-to-the-check-in-app.md){target="_blank"} et attribution du nouveau rôle
* [Créer un nouveau programme d’événement Marketo](/help/marketo/product-docs/demand-generation/events/understanding-events/create-a-new-event-program.md){target="_blank"}
* Définition des dates d’événement
* Ajout de personnes à votre événement

## Configuration de la tablette [!DNL iPad] ou [!DNL Android]

Pour préparer la tablette [!DNL iPad] ou [!DNL Android] :

* Téléchargez et installez l’application de tablette [!DNL iPad] ou [!DNL Android] des événements Marketo
...
## Vérifier les personnes dans à l’aide de [!DNL iPad] ou de la tablette

Lors de l’événement :

* Connexion à l’application
* Rechercher des invités (et créer des personnes)
* [Archivage des invités](/help/marketo/product-docs/core-marketo-concepts/mobile-apps/event-check-in/check-people-into-your-event-from-your-tablet.md){target="_blank"} (archétypes, modification des enregistrements de personne à l’archivage)
* Synchroniser l’application de tablette [!DNL iPad] ou [!DNL Android] avec Marketo
