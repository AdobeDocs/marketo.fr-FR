...
description: Découvrez les listes dynamiques pour rechercher des groupes de personnes avec des filtres dans Marketo. Créez et utilisez des listes dynamiques dans des campagnes, des programmes et des rapports.
...
1. [Créer une liste intelligente](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/creating-a-smart-list/create-a-smart-list.md){target="_blank"}
1. [Rechercher et ajouter des filtres à une liste intelligente](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/creating-a-smart-list/find-and-add-filters-to-a-smart-list.md){target="_blank"}
1. [Définir des filtres pour une liste intelligente](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/creating-a-smart-list/define-smart-list-filters.md){target="_blank"}
