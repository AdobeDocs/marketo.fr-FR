...
>[!NOTE]
>
>Vous pouvez également voir les informations d’opportunité [insérées via l’API](https://experienceleague.adobe.com/fr/docs/marketo-developer/marketo/rest/lead-database/opportunities) pour les instances qui ne sont pas synchronisées avec un CRM.
