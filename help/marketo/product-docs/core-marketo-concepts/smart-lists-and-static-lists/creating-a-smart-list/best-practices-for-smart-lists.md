...
description: Obtenez de l’aide sur les bonnes pratiques relatives aux listes dynamiques. Créez des listes plus rapides et plus précises grâce à ces conseils.
...
Pour faciliter leur utilisation et optimiser les performances, les bonnes pratiques suivantes sont fournies.
...
1. **Utiliser l’échantillon aléatoire en lui-même -** L’échantillon aléatoire est un filtre spécial. Utilisez-la seule pour placer vos employés dans des listes prédéfinies. Ensuite, utilisez « Membre de la liste » pour rendre votre liste dynamique super rapide. Random Sample **NOT** fonctionne avec les listes dynamiques imbriquées. Le filtre Échantillon aléatoire ne fonctionne pas s’il s’agit de la liste dynamique référencée pour le filtre « Membre de la liste dynamique ».
...
1. **Simplifiez vos campagnes -** plus de 100 règles indépendantes vont évidemment prendre un certain temps à traiter. Restez simple et vous remarquerez les gains de vitesse - en plus, il sera plus facile pour vous de comprendre.
