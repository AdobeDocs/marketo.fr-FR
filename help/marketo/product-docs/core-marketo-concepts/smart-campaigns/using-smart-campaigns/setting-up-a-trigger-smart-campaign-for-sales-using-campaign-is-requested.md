...
description: Découvrez comment configurer un déclencheur de campagne intelligente pour les ventes à l’aide de Campaign is Requested. Autoriser les campagnes de demande de vente pour les prospects du CRM.
...
>
>1. **Soutien à long terme** - lorsqu’ils n’ont pas de budget cette année et que vous souhaitez rester sur le radar
>1. **Cycle de vente actif** - lorsque le vendeur ne souhaite pas recevoir de messages de la personne, à l&#39;exception du sien. (utilisez l’indicateur marketing suspendu pour les désabonner temporairement)
>
>Demandez à l&#39;équipe des ventes ce qu&#39;elle souhaite automatiser et configurer.
...
1. Les choix de la source indiquent le type de demande qui sera honoré. Pour la fonctionnalité Salesforce, choisissez **[!UICONTROL Sales Insight]**.
   ...
   >
   >_Souvenez-vous_ en choisissant Sales Insight, il apparaîtra par comme par magie dans la boîte pour les ventes. Évitez d’en ajouter trop, car ils seront ignorés.
...
>[!TIP]
>
>Nommez vos campagnes intelligentes clairement. Ils apparaîtront dans Sales Insight exactement comme vous les nommez.
