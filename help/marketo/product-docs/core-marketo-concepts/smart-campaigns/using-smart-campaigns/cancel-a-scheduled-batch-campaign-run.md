...
# Annulation d’une exécution de campagne par lots planifiée {#cancel-a-scheduled-batch-campaign-run}
...
>[!NOTE]
>
>Cela n’aidera pas si l’exécution a déjà commencé. Utilisez-le lorsque vous décidez qu’une exécution future doit être annulée.
