...
1. Sélectionnez la campagne à cloner. Dans le **Actions de campagne** menu déroulant, sélectionnez **Cloner**.

   ![](assets/campaign-actions-clone-a-smart-campaign-1.png)

1. Choisissez la **Cloner vers** . Dans cet exemple, nous allons choisir **Programmes**.

   ![](assets/campaign-actions-clone-a-smart-campaign-2.png)

1. Choisissez une **Programme**. Saisissez un **Nom de la campagne** et cliquez sur **Cloner**.
