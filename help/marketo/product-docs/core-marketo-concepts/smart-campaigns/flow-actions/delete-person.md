...
description: Découvrez comment supprimer une personne de la base de données avec une étape de flux. Supprimez de Marketo les personnes qui répondent aux critères.
