...
# Utilisation de Webhook dans une Campaign intelligente {#use-a-webhook-in-a-smart-campaign}

Pour utiliser un crochet [](http://developers.marketo.com/documentation/webhooks/)Web, ajoutez-le à une campagne [](add-a-flow-step-to-a-smart-campaign.md) intelligente en tant qu’action de flux.
...
1. Accédez à l&#39;onglet **Flux** et faites glisser l&#39;action de flux **Call Webhook** .
...
1. Enfin, vous pouvez utiliser des crochets Web dans Choix **d’Ajoute** dans une étape de flux.
