...
# Demande de Campaign {#request-campaign}

Vous pouvez placer des personnes dans une campagne spécifique à l’aide de l’étape de flux unique **Request Campaign** .

>[!NOTE]
>
>La campagne dans laquelle vous placez la personne doit être principale et avoir le déclencheur ** [Campaign est Requested](../../../../product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/setting-up-a-trigger-smart-campaign-for-sales-using-campaign-is-requested.md)**.
