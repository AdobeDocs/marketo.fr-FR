...
Le calendrier marketing vous donne une vue visuelle des choses, mais il permet également certaines interactions. Vous pouvez [créer](/help/marketo/product-docs/core-marketo-concepts/marketing-calendar/working-with-the-calendar/create-entries-directly-in-the-marketing-calendar.md), [modifier](/help/marketo/product-docs/core-marketo-concepts/marketing-calendar/working-with-the-calendar/edit-entries-directly-in-the-marketing-calendar.md), [supprimer](/help/marketo/product-docs/core-marketo-concepts/marketing-calendar/working-with-the-calendar/delete-entries-directly-in-the-marketing-calendar.md) et [confirmer](/help/marketo/product-docs/core-marketo-concepts/marketing-calendar/working-with-the-calendar/confirm-entries-directly-in-the-marketing-calendar.md) les entrées. Pour interagir avec les entrées, vous devez d’abord vous concentrer sur un programme.

1. Accédez au **Calendrier marketing**.

   ![](assets/2017-05-10-15-30-47-1.png)

1. Sélectionnez une entrée et cliquez sur **Afficher la cible d’action du Programme**.
...
>[!MORELIKETHIS]
>
>* [Créer directement des entrées dans le calendrier marketing](/help/marketo/product-docs/core-marketo-concepts/marketing-calendar/working-with-the-calendar/create-entries-directly-in-the-marketing-calendar.md)
