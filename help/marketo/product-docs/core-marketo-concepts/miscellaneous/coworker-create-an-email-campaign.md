...
>[!IMPORTANT]
>
>Actuellement, vous pouvez uniquement générer des campagnes. Vous ne pouvez pas encore les envoyer (lancement). La fonctionnalité de Launch sera bientôt disponible.

## Avant de commencer

Vérifiez que vous disposez des éléments suivants :

* Un compte Adobe CX Enterprise Coworker Campagnes actif ([inscrivez-vous ici](https://coworker-essentials.experience.adobe.com/){target="_blank"} si ce n’est pas déjà fait).
...
![Écran d’accueil présentant les trois différentes options pour commencer](assets/create-an-email-campaign-1.png){width="800" zoomable="yes"}
...
![Saisie dans votre propre invite](assets/create-an-email-campaign-2.png)
...
1. Après avoir envoyé votre invite, passez en revue les tâches que Coworker exécutera et cliquez sur **Créer**.

1. Dans le volet _Conversion de Campaign_ à gauche, cliquez sur **Télécharger CSV**.

   ![](assets/create-an-email-campaign-3.png)

   >[!NOTE]
   >
   >* L’adresse e-mail est un champ obligatoire, le prénom, la date du dernier achat et tout autre champ pouvant être utilisé à des fins de personnalisation est recommandé.
...
* Utilisez l’interface de conversation pour apporter des modifications en parlant directement aux campagnes de vos collègues. Voici quelques exemples :
