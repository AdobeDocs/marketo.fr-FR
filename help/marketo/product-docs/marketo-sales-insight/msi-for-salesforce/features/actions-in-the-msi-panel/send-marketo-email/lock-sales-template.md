...
description: Découvrez comment verrouiller un modèle de vente dans Marketo Sales Insight. Empêcher les modifications apportées à un modèle pour que les ventes utilisent la version approuvée.
