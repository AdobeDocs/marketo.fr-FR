...
1. Cliquez sur le bouton **Obtenir maintenant** bouton . Il vous sera demandé de choisir l’emplacement où vous souhaitez installer. Vous aurez la possibilité de mettre à niveau car vous disposez déjà d’une version précédente de MSI. Choisissez une option en fonction du compte auquel vous vous êtes connecté à l’étape 1.
