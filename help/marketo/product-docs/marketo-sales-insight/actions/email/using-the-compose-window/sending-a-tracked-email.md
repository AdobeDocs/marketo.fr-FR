...
>
>* [Vérification de l’adresse électronique](/help/marketo/product-docs/marketo-sales-insight/actions/getting-started/email-settings/verify-your-email.md)
...
1. Composez votre email à l&#39;aide de l&#39;éditeur. Cliquez sur **Envoyer** (ou [Planification](/help/marketo/product-docs/marketo-sales-connect/email/using-the-compose-window/scheduling-an-email.md), si vous préférez) une fois terminé.
   ...
   >[!MORELIKETHIS]
   >
   >* [Planification d’un email](/help/marketo/product-docs/marketo-sales-insight/actions/email/using-the-compose-window/scheduling-an-email.md)
