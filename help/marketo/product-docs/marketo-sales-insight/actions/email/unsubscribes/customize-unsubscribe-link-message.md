---
description: Découvrez comment personnaliser le message du lien de désabonnement dans les e-mails de vente. Modifiez le texte que les utilisateurs voient lorsqu’ils se désinscrivent.
