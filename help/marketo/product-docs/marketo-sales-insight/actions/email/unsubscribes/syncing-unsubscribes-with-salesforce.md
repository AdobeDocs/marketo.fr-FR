---
description: Découvrez comment synchroniser les désabonnements entre les actions Sales Insight et Salesforce. Conservez la cohérence du statut de désinscription sur l’ensemble des systèmes.
