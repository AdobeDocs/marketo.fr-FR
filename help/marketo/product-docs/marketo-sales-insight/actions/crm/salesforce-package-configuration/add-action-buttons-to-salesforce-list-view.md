...
>[!NOTE]
>
>Ces boutons font partie du package Sales Insight . Si vous ne voyez pas les boutons disponibles à installer dans le mode Liste, vous devrez peut-être [mettre à niveau votre package](/help/marketo/product-docs/marketo-sales-insight/msi-for-salesforce/upgrading/upgrading-your-msi-package.md){target="_blank"}.
...
1. Sélectionnez **Modifier** en regard de la mise en page à laquelle vous souhaitez ajouter les boutons.
