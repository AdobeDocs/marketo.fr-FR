...
## Utilisation de tâches de rappel dans les campagnes commerciales {#using-reminder-tasks-in-sales-campaigns}

Les tâches sont un outil puissant lors de l’envoi d’une campagne de ventes à un contact, en particulier si votre processus de vente est multicanal/tactile.

Les tâches pour envoyer un courrier électronique et une tâche pour appeler un contact sont les utilisations les plus courantes des tâches dans les campagnes de ventes.
...
>[!NOTE]
>
>Ce qui est le plus important à propos des tâches dans les campagnes commerciales, vous devez terminer la tâche pour déclencher l’étape suivante.
