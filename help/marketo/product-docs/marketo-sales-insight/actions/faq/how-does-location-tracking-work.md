---
description: Découvrez comment fonctionne le tracking pour les e-mails de vente. Découvrez quelles données d’emplacement sont collectées et comment elles sont utilisées.
