---
description: Configuration de Salesforce - Documents Marketo - Documentation du produit
title: Configuration Salesforce
hide: true
hidefromtoc: true
...
## Désinstallation du module de personnalisation Salesforce (Classic) {#uninstall-salesforce-customization-package-classic}
...
**Suppression des champs de connexion aux ventes de la mise en page**
...
**Suppression des boutons de connexion aux ventes des mises en page**
...
**Suppression des champs de connexion aux ventes de la section Historique des activités**
...
1. Ensuite, sélectionnez les champs de connexion des ventes dans la zone Champs sélectionnés et cliquez sur la flèche Supprimer . Cliquez sur **OK** une fois terminé.
...
**Suppression des boutons d’action en bloc Connect Sales du mode Liste des pistes**
...
**Suppression de la configuration du MSC pour les contacts**
...
**Suppression de la configuration du MSC pour les opportunités**
...
**Suppression de la configuration MSC pour un compte**
...
**Supprimer la boîte d’envoi des ventes Marketo**
...
**Supprimer le module Sales Connect**
...
**Détails de la personnalisation de Sales Connect**
