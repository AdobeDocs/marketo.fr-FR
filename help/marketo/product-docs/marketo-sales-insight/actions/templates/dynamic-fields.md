---
description: En savoir plus sur les champs dynamiques dans les modèles d’actions Sales Insight. Utilisez des champs de fusion pour personnaliser les e-mails avec les données de contact et d’expéditeur.
