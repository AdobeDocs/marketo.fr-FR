...
[Ajouter un administrateur de produit](/help/marketo/product-docs/administration/marketo-with-adobe-identity/add-or-remove-a-product-admin.md#add-a-product-admin){target="_blank"}

## Gestion des utilisateurs {#user-management}

Ajout et suppression d’utilisateurs. Terminé par l’administrateur de produit (ou système)
Admin).
...
[Ajouter un utilisateur API uniquement pour les abonnements activés par Adobe IMS](/help/marketo/product-docs/administration/marketo-with-adobe-identity/add-api-only-user-for-adobe-ims-enabled-subscriptions.md){target="_blank"}

## Ajout d’utilisateurs au format CSV {#add-users-via-csv}

[Importer un fichier CSV](https://helpx.adobe.com/enterprise/using/bulk-upload-users.html#add-users){target="_blank"}
