...
1. [Créez un utilisateur d’API](/help/marketo/product-docs/administration/users-and-roles/create-api-only-user.md){target="_blank"} en utilisant le rôle d’API [!DNL BrightTALK] que vous avez créé à l’étape 4.
