...
1. Dans la zone Restrictions d’IP, cliquez sur **Modifier,** ou cliquez sur **Modification des restrictions IP** en haut à gauche.

   ![](assets/create-an-allowlist-for-ip-based-api-access-3.png)

1. Vérifiez les **Activer les restrictions IP** et saisissez les adresses IP à placer sur la liste autorisée.
...
1. Cliquez sur **Ajouter** pour ouvrir des champs supplémentaires afin de saisir d’autres adresses IP.
