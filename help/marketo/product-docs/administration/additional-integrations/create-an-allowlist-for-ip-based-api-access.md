...
>[!CAUTION]
>
>Enabling this feature prevents you from being able to access the [Marketo MCP Server](https://experienceleague.adobe.com/fr/docs/marketo-developer/marketo/mcp-server){target="_blank"} at this time. This will be fixed in an upcoming release.
