...
1. Dans Mon Marketo, accédez à **[!UICONTROL Base]**.

   ![](assets/import-custom-object-data-1.png)

1. Cliquez sur **[!UICONTROL Nouveau]** et sélectionnez **[!UICONTROL Importer des données d’objet personnalisées]**.
...
1. Cliquez sur **[!UICONTROL Importer]**.
   ...
   >[!TIP]
   >
   >Saisissez votre adresse électronique dans la zone **[!UICONTROL Envoyer une alerte à]** et Marketo vous enverra un e-mail une fois votre importation terminée.
