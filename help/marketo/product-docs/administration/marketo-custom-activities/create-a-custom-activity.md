...
description: Procédure à suivre pour créer une activité personnalisée, y compris le nom, le nom de l’API, la définition de filtre et de déclencheur et le champ principal.
