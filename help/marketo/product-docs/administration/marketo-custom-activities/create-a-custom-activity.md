...
1. Saisissez un nom et une valeur facultative. [!UICONTROL Description], puis cliquez sur **[!UICONTROL Suivant]**. Le nom de l’API est renseigné automatiquement, mais il peut être personnalisé.
...
1. Définissez vos [!UICONTROL Filtrer] et [!UICONTROL Déclencheur] et cliquez sur **[!UICONTROL Suivant]**.
