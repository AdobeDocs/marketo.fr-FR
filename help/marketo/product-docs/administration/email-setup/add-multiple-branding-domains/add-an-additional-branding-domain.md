...
Ajoutez un domaine de branding supplémentaire lorsque vous exécutez plusieurs marques à partir d’une seule instance Marketo et souhaitez que chacune d’elles dispose de ses propres liens de suivi de branding.
...
<tr>
    ...
    <td>Un domaine portant le même nom existe déjà.</td>
  </tr>
  <tr>
    <td><i>Le domaine n’est pas mappé au domaine par défaut.</i></td>
    <td>Le domaine personnalisé n’est pas correctement mappé au domaine par défaut. Vérifiez les paramètres de mappage de domaine et assurez-vous que la configuration DNS pointe vers le domaine par défaut approprié.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Un problème s’est produit lors de la recherche du domaine par défaut. Contactez l’assistance pour toute enquête.</td>
  </tr>
  <tr>
    <td><i>Erreur inattendue lors de la création d'un domaine. Contactez l’assistance pour obtenir de l’aide.</i></td>
    <td>Une erreur inattendue s’est produite. Rassemblez les journaux et les détails des erreurs, puis signalez le problème à l'assistance Marketo <a href="https://nation.marketo.com/t5/support/ct-p/Support" target="_blank"></a>.</td>
  </tr>
</tbody></table>
