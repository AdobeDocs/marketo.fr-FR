...
1. Dans le tableau Domaines de promotion de la marque, sélectionnez le domaine générique actuel et cliquez sur Modifier pour le modifier en domaine de votre société.
   ...
   >[!NOTE]
   >
   >**L&#39;Ajoute****  **ne fonctionne pas tant que vous n&#39;avez pas modifié le domaine générique.** La suppression ******ne fonctionne pas tant que vous n’avez pas ajouté un second domaine.
   >
...
Désormais, vous pouvez [ajouter des domaines de marque](add-an-additional-branding-domain-with-workspaces.md) supplémentaires dont vous avez besoin pour les espaces de travail.
