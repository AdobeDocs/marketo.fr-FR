...
description: Découvrez les champs gérés par le système non modifiables sur la page des détails de la personne et ce que signifie chaque type de champ.
...
<tbody>
  ...
  <tr>
    <td>Contact</td>
    <td>La personne a été synchronisée à partir de Salesforce en tant que contact</td>
  </tr>
  <tr>
    <td>API Munchkin</td>
