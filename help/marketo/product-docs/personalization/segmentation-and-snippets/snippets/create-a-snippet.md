...
description: Découvrez comment créer un fragment de code pour le contenu dynamique sur les e-mails et les landing pages. Créez un fragment de code et ajoutez du contenu à réutiliser dans les ressources.
