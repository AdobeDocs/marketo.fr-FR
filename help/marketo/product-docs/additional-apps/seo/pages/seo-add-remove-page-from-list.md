...
description: Ajoutez ou supprimez des pages des listes pour organiser les pages et filtrer les données dans les tableaux de bord.
...
Gérez facilement vos pages en créant une liste. Vous pouvez utiliser des listes pour organiser les pages ou filtrer les données dans les tableaux de bord.
