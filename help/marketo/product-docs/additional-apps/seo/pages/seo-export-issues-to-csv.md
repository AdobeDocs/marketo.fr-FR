...
description: Exportez les problèmes d’optimisation de page dans un fichier CSV à partir de l’analyse des détails de page pour les partager en dehors de Marketo.
...
Vous pouvez exporter les données relatives aux événements de votre page dans un fichier CSV si vous souhaitez partager ces informations avec des personnes extérieures à Marketo. Voici comment faire.
...
1. Cliquez sur la page dont vous souhaitez afficher les détails.
   ...
   Il s’agit de l’analyse des détails de la page. **[!UICONTROL Résultats de l’optimisation de la page]** est une liste de tous les problèmes liés à cette page en particulier.
