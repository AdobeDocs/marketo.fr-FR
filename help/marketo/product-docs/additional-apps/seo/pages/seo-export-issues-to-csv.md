...
Découvrez comment exporter les données relatives aux problèmes de page dans un fichier CSV si vous envisagez de partager ces informations avec des personnes extérieures à Marketo.
...
1. Cliquez sur la page dont vous souhaitez afficher les détails.
   ...
   L’analyse détaillée de la page s’affiche. **[!UICONTROL Résultats de l’optimisation de la page]** est une liste de tous les problèmes liés à cette page en particulier.
