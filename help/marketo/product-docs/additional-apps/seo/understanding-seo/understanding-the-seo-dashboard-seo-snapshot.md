...
description: Utilisez le tableau de bord d’optimisation du moteur de recherche pour afficher les tendances de classement des mots-clés, le score moyen d’optimisation des pages et le résumé de classement des mots-clés pour votre site.
