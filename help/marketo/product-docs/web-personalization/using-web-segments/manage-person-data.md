...
description: Découvrez comment gérer les données de personne dans Marketo Engage, notamment comment gérer les données de personne manage-person-data. Utilisez ce guide pour passer à l’étape suivante.
