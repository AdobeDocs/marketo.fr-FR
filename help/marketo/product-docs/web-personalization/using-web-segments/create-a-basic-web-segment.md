...
description: Découvrez comment créer un segment web de base dans Marketo Engage à l’aide de la commande create-a-basic-web-segment. Passez à l’étape suivante en toute confiance.
