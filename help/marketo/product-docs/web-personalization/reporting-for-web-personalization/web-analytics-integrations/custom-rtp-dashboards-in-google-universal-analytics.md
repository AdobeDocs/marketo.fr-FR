...
1. Sélectionner **Canevas vierge**, ajoutez une **Nom du tableau de bord** et cliquez sur **Créer un tableau de bord**.
...
1. Créez un tableau de bord appelé **Tableau de bord RTP B2B** et définissez les widgets suivants :
  ...
  <tr> 
   <td> 
    <ul> 
     ...
     <li>Regroupés par : Libellé de l’événement</li> 
   ...
   <td> 
    <ul> 
     ...
     <li>Regroupés par : RTP-Industry</li> 
  ...
  <tr> 
   <th> 
    <ul> 
     ...
     <li><strong>Regroupés par : RTP-Industry</strong></li> 
  ...
  <tr> 
   ...
   <th> 
    <ul> 
     ...
     <li>Regroupés par : Action d’événement</li> 
  ...
  <tr> 
   ...
   <th> 
    <ul> 
     ...
     <li>Afficher les colonnes suivantes : <br>Libellé d’événement | Sessions | Taux de conversion de l’objectif</li> 
     <li>Filtre : <br>Afficher uniquement | Catégorie d’événements (contenant) RTP-Segments</li> 
...
<table> 
 <thead> 
  <tr> 
   <th> 
    <div> <strong>Exposition sur les campagnes de la colonne 1</strong> 
    </div></th> 
   <th> 
    <div> <strong>Clics publicitaires sur les campagnes de la colonne 2</strong> 
    </div></th> 
   <th> 
  ...
  <tr> 
   <td> 
    <ul> 
     ...
     <li>Afficher la mesure suivante : <strong>Nombre total d’événements</strong></li> 
     <li>Filtres :<br><strong>[afficher uniquement] Catégorie d’événements (contient) : RTP-Campagnes</strong><br><strong>[afficher uniquement] Action de l’événement (correspondance exacte) : Impression</strong><strong>[ne pas afficher] Libellé de l’événement (contenant) : #</strong></li> 
   ...
   <td> 
    <ul> 
     ...
     <li>Type : <strong>2.1 Mesure </strong></li> 
     <li>Afficher la mesure suivante : <strong>Nombre total d’événements</strong></li> 
     <li>Filtres :<br><strong>[afficher uniquement] Catégorie d’événements (contient) : RTP-Campagnes</strong><br><strong>[afficher uniquement] Action d’événement (correspondance exacte) : Clics</strong><strong>[ne pas afficher] Libellé de l’événement (contenant) : #</strong></li> 
  ...
  <tr> 
   <td colspan="1"> 
    <ul> 
     ...
     <li>Filtres :<br><strong>[afficher uniquement] Catégorie d’événements (correspondance exacte) : RTP-Campagnes</strong><br><strong>[afficher uniquement] Action d’événement (correspondance exacte) : impression</strong><strong>[ne pas afficher] Libellé de l’événement (contenant) : #</strong></li> 
   ...
   <td colspan="1"> 
    <ul> 
     ...
     <li>Type : <strong>2.1 Mesure </strong></li> 
     <li>Afficher la mesure suivante : <strong>Durée Durée de la session</strong></li> 
     <li>Filtres :<br><strong>[afficher uniquement] Catégorie d’événements (correspondance exacte) : RTP-Campagnes</strong><br><strong>[afficher uniquement] Action d’événement (correspondance exacte) : clics</strong><strong>[ne pas afficher] Libellé de l’événement (contenant) : #</strong></li> 
  ...
  <tr> 
   <td> 
    <ul> 
     ...
     <li><strong>[afficher uniquement] Action d’événement (correspondance exacte) : impression</strong></li> 
   ...
   <td> 
    <ul> 
     ...
     <li>Afficher la mesure suivante : <strong>Pages / Session</strong></li> 
     <li>Filtres :<br><strong>[afficher uniquement] Catégorie d’événements (correspondance exacte) : RTP-Campagnes</strong></li> 
     <li><strong>[afficher uniquement] Action d’événement (correspondance exacte) : clics</strong></li> 
     <li><strong>[ne pas afficher] Libellé de l’événement (contenant) : #</strong></li> 
  ...
  <tr> 
   <td> 
    <ul> 
     ...
     <li>Afficher les colonnes suivantes : <strong>Libellé d’événement | Événements totaux | Utilisateurs</strong></li> 
     <li>Filtres :<br><strong>[afficher uniquement] Catégorie d’événements (correspondance exacte) : RTP-Campagnes</strong><br><strong>[afficher uniquement] Action d’événement (correspondance exacte) : impression</strong><strong>[ne pas afficher] Libellé de l’événement (contenant) : #</strong></li> 
   ...
   <td> 
    <ul> 
     ...
     <li>Type : <strong>Tableau</strong></li> 
     <li>Afficher les colonnes suivantes : <strong>Libellé d’événement | Événements totaux | Utilisateurs</strong></li> 
     <li>Filtres :<br><strong>[afficher uniquement] Catégorie d’événements (correspondance exacte) : RTP-Campagnes</strong><br><strong>[afficher uniquement] Action d’événement (correspondance exacte) : clics</strong></li> 
