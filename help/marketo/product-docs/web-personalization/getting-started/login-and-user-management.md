...
1. Saisissez un [!UICONTROL Nom du rôle] et sélectionnez [!UICONTROL Autorisations]. Cliquez sur **[!UICONTROL Créer]** (ce rôle doit [s’appliquer à tous les espaces de travail](/help/marketo/product-docs/administration/users-and-roles/edit-user-workspaces.md)).
