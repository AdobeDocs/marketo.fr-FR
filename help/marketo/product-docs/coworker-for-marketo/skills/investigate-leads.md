...
1. Un collègue de Marketo Engage récupère le dossier du prospect et son historique pertinent.

1. Consultez l’explication. Un collègue de Marketo Engage vous indique la raison spécifique pour laquelle le jalon n’a pas été atteint et, si possible, ce qui doit changer pour que le prospect soit qualifié.
...
* Si l’historique des activités d’un prospect est très long, Collègue de Marketo Engage se concentre sur les événements les plus récents et les plus pertinents liés à votre question.
