...
>[!TIP]
>
>Il est recommandé d’appuyer sur la touche **Mettre à jour les comptes existants** avant d’effectuer une nouvelle recherche de compte pour vous assurer que vous consultez les données les plus récentes. Cette mise à jour peut prendre jusqu’à 24 heures.
...
1. Cliquez sur le bouton **Nouveaux comptes** .
...
1. Cliquez sur **Enregistrer tout et créer une liste** en bas à droite de la page.
   ...
   >[!NOTE]
   >
   >Si vous ne voyez que quelques comptes, vous avez la possibilité de cliquer sur des comptes individuels et de cliquer sur **Enregistrer les comptes sélectionnés** une fois terminé.
...
1. Vous pouvez faire de votre liste sa propre nouvelle liste de comptes ou l’ajouter à une liste existante. Dans cet exemple, nous allons en créer un nouveau.
   ...
   >[!NOTE]
   >
   >Pour l’enregistrer dans une liste de comptes existante, sélectionnez cette option, cliquez sur la liste déroulante, sélectionnez la liste de comptes de votre choix, puis cliquez sur **Suivant**.
...
1. Cliquez sur **Enregistrer**.
   ...
   >[!NOTE]
   >
   >Vous ne pouvez enregistrer que jusqu’à 5 000 comptes à la fois. Si votre recherche génère 10 000 résultats, vous devrez enregistrer le premier (premier) 5 000, puis réinitialiser les filtres et enregistrer le prochain 5 000. Le **total** la limite de compte est d’un million.
