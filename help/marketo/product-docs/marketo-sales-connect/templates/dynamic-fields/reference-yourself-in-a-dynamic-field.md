...
description: Découvrez comment vous référencer dans un champ dynamique Sales Connect. Utilisez le nom de l’expéditeur ou les détails dans la personnalisation du modèle.
