...
description: Découvrez la page Sales Connect Analytics et les données d’engagement par e-mail. Affichez les statistiques des individus et des équipes sur les onglets Moi, Équipe et Contenu.
...
# Aperçu de la page [!UICONTROL Analytics] {#analytics-page-overview}

L’onglet [!UICONTROL Analytics] vous permet d’afficher les données relatives à l’engagement de vos e-mails. Les données individuelles et d’équipe s’affichent. Les administrateurs peuvent également filtrer par utilisateur dans l’onglet [!UICONTROL Moi].
...
L’onglet [!UICONTROL Moi] est un excellent endroit pour vérifier l’engagement de vos e-mails, modèles et liens. Si vous êtes un administrateur dans [!DNL Sales Connect], vous pouvez filtrer par utilisateur de votre équipe pour afficher ses statistiques.
