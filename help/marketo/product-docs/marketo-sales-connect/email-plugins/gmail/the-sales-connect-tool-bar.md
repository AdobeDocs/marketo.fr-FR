...
| **[!UICONTROL Boutons Modèles et conversations]** | Ouvre respectivement la page [!UICONTROL Modèles] et la page [!UICONTROL Conversations] de votre [application web](https://toutapp.com/login). Le tout dans votre page Gmail. |
