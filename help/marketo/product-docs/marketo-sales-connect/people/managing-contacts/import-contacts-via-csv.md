...
description: Découvrez comment importer des contacts au moyen d’un fichier CSV dans Sales Connect. Chargez un fichier CSV pour ajouter plusieurs contacts ou groupes à la fois.
title: Importer des contacts via un fichier CSV
...
# Importer des contacts via un fichier CSV {#import-contacts-via-csv}
