...
Pour ce faire, votre administrateur informatique doit suivre les étapes répertoriées dans la [page de paramètres](http://toutapp.com/custom_tracking_domain).
