...
description: Découvrez comment utiliser un modèle dans la fenêtre Composer Sales Connect. Insérer un modèle et le personnaliser avant d'envoyer les e-mails trackés
