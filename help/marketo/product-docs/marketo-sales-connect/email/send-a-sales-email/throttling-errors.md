...
Si vous envoyez par l&#39;intermédiaire de votre propre serveur, le nombre de courriers électroniques que vous pouvez envoyer simultanément sera limité. Lors de l&#39;envoi via Sales Connect, vous avez la possibilité d&#39;envoyer de nombreux e-mails, mais nous essayons de les envoyer tous en même temps. Donc si vous savez que votre serveur va vous couper 100 courriels par minute, vous n&#39;aurez besoin que de 100 courriels par minute pour envoyer jusqu&#39;à 100 courriels par le biais de l&#39;application [](http://toutapp.com/login)web. Dans le cas contraire, les courriels peuvent arriver ici en raison du ralentissement des courriels sur votre serveur.
