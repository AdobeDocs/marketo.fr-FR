...
description: Découvrez comment réabonner un contact qui s’est désabonné dans Sales Connect. Rétablissez leur capacité à recevoir des e-mails de vente, le cas échéant.
