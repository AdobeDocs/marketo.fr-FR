...
<br/> Dans l’affirmative, votre rôle d’« administrateur système de Adobe Admin Console » vous a-t-il été attribué ? Si vous ne savez pas qui, dans votre organisation, dispose de privilèges d’administrateur dans la console, contactez l’<a href="https://helpx.adobe.com/fr/contact.html" target="_blank">Assistance clientèle d’</a>.</li>
...
<br/> Dans le cas contraire, recherchez l’e-mail de bienvenue <a href="/help/marketo/product-docs/administration/marketo-with-adobe-identity/admin-setup.md#initial-setup" target="_blank"> </a> dans votre boîte de réception et acceptez l’invitation à activer votre Adobe ID.</li></td>
  </tr>
  <tr>
...
<br/> Dans le cas contraire, veillez à <a href="/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user.md" target="_blank">ajouter et/ou supprimer des utilisateurs</a> des profils de produit Marketo Engage dans Adobe Admin Console. Vous ne pouvez pas affecter les rôles des utilisateurs dans Marketo Engage &gt; Admin &gt; Utilisateurs et rôles s’ils sont ajoutés à un profil de produit.</li>
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <p>
   <li>Combien d’utilisateurs y a-t-il ?</li>
...
<table style="table-layout:auto">
 <tbody>
  ...
  <tr>
   ...
   <td><li>Combien d’espaces de travail et/ou de partitions </a> avez-vous ?<a href="/help/marketo/product-docs/administration/workspaces-and-person-partitions/understanding-workspaces-and-person-partitions.md" target="_blank"></li>
...
<table style="table-layout:auto">
 <tbody>
  ...
  <tr>
   ...
   <br/> Cliquez sur <a href="/help/marketo/product-docs/administration/field-management/export-a-list-of-all-marketo-api-field-names.md" target="_blank">Exporter les noms de champ</a> pour consulter une liste de vos champs, de vos champs personnalisés et de leurs noms d’API.</li>
...
<br/> Sélectionner <a href="/help/marketo/product-docs/administration/field-management/export-used-by-data-for-a-field.md" target="_blank"> Exportation utilisée par </a> dans le menu déroulant Actions de champ pour passer en revue les ressources associées d’un champ.</li>
...
<br/> Dans le cas contraire, envisagez d’implémenter cette .</li>
...
<br/> Confirmez si les ressources de votre page de destination contiennent une URL « http ».</li></td>
  </tr>
  <tr>
   <td>Munchkin</td>
...
<td>Vous devrez accéder à <a href="https://adminconsole.adobe.com/" target="_blank"></a> en suivant les étapes ci-dessous. Si vous n’avez pas encore configuré d’Adobe ID, <a href="https://helpx.adobe.com/fr/manage-account/using/create-update-adobe-id.html" target="_blank">découvrez comment faire ici</a>.
<br/>
