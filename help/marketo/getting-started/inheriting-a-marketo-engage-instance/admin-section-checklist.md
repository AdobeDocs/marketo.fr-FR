...
<td>Suivez les étapes ci-dessous pour accéder à <a href="https://adminconsole.adobe.com/" target="_blank">Adobe Admin Console</a>. Si vous n'avez pas encore configuré Adobe ID, <a href="https://helpx.adobe.com/fr/manage-account/using/create-update-adobe-id.html" target="_blank">apprenez à le faire ici</a>.
<br/>
