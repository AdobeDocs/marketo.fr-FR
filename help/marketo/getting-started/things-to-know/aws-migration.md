...
Pour obtenir les dernières informations, mettez un signet sur cette page. Pour recevoir des mises à jour de statut au début et à la fin de la migration, [abonnez-vous](https://experienceleague.adobe.com/en/docs/marketo/using/getting-started/things-to-know/system-status-notifications){target="_blank"} pour les recevoir. Vous pouvez également consulter le site https://status.adobe.com/ pendant la période de migration.
