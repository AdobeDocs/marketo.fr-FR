...
1. Envoyer une URL pour les modèles de Landing page et de courriel
   ...
   Pour CNAME, saisissez le CNAME de landing page que vous avez sélectionné à l’étape 3 (`[LandingPageCNAME]`). Envoyez votre demande.
