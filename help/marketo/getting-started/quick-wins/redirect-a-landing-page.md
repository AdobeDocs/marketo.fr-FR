...
1. Cliquez sur la première liste déroulante URL **** d’origine et sélectionnez votre CNAME de marketing.
   ...
   >[!NOTE]
   >
   >N’oubliez pas que vous ne pouvez rediriger que les landings page qui début avec votre [CNAME](/help/marketo/product-docs/demand-generation/landing-pages/landing-page-actions/customize-your-landing-page-urls-with-a-cname.md)de marketing.

1. Cliquez sur la deuxième liste déroulante URL **** d’origine et sélectionnez le landing page à rediriger.

   ![](assets/image2014-9-24-13-3a30-3a50.png)

1. Pour l’URL **de** redirection, sélectionnez la page vers laquelle vous souhaitez rediriger et cliquez sur **Créer**.
