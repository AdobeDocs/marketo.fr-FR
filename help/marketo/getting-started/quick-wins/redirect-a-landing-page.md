...
1. Accédez à **[!UICONTROL Pages d’entrée]**.

   ![](assets/redirect-a-landing-page-2.png)

1. Cliquez sur le bouton **[!UICONTROL Règles]** , puis cliquez sur **[!UICONTROL Nouveau]** et **[!UICONTROL Nouvelle règle de redirection]**.

   ![](assets/redirect-a-landing-page-3.png)

## Étape 2 : Définition de la règle de redirection {#step-define-the-redirect-rule}

1. Cliquez sur le premier **[!UICONTROL URL d’origine]** et sélectionnez votre CNAME Marketo.
...
1. Cliquez sur la seconde **[!UICONTROL URL d’origine]** et sélectionnez la landing page à rediriger.

   ![](assets/redirect-a-landing-page-5.png)

1. Pour **[!UICONTROL URL de redirection]** sélectionnez la page vers laquelle vous souhaitez rediriger et cliquez sur **[!UICONTROL Créer]**.
