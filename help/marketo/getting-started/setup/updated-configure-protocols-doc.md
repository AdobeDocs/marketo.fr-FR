---
description: Documentation de configuration des protocoles mise à jour - Documents Marketo - Documentation du produit
title: Documentation sur la configuration des protocoles mise à jour
hide: true
hidefromtoc: true
...
# Documentation sur la configuration des protocoles mise à jour {#updated-configure-protocols-doc}
...
## Étape 4 : configuration DMARC (Authentification des messages basée sur le domaine, création de rapports et conformité) {#set-up-dmarc}

DMARC est un protocole d’authentification utilisé pour aider les entreprises à protéger leur domaine contre toute utilisation non autorisée. DMARC étend les protocoles d’authentification existants, tels que SPF et DKIM, pour informer les serveurs destinataires des actions qu’ils doivent entreprendre en cas d’échec de l’authentification sur leur domaine. Bien que DMARC soit actuellement facultatif, il est vivement recommandé, car il protège mieux la marque et la réputation de votre entreprise. À compter de février 2024, les principaux fournisseurs tels que Google et Yahoo auront besoin de DMARC pour les expéditeurs en masse.
